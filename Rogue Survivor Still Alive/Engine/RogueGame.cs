...
namespace djack.RogueSurvivor.Engine
{
  internal class RogueGame
  {
    ...
    public RogueGame(IRogueUI UI)
    {
      ...
      BaseTownGenerator.Parameters defaultParams = BaseTownGenerator.DEFAULT_PARAMS;
      defaultParams.MapWidth = defaultParams.MapHeight = 100;
      Logger.WriteLine(Logger.Stage.INIT_MAIN, "creating Generator");
      this.m_TownGenerator = (BaseTownGenerator) new StdTownGenerator(this, defaultParams);
    ...
    private void InitDirectories()
    {
      ...
      int gy2 = gy1 + 14;
      this.m_UI.UI_Repaint();
      if ((0 | (this.CheckDirectory(RogueGame.GetUserBasePath(), "base user", ref gy2) ? 1 : 0) | (this.CheckDirectory(RogueGame.GetUserConfigPath(), "config", ref gy2) ? 1 : 0) | (this.CheckDirectory(RogueGame.GetUserGraveyardPath(), "graveyard", ref gy2) ? 1 : 0) | (this.CheckDirectory(RogueGame.GetUserSavesPath(), "saves", ref gy2) ? 1 : 0) | (this.CheckDirectory(RogueGame.GetUserScreenshotsPath(), "screenshots", ref gy2) ? 1 : 0) | (this.CheckCopyOfManual() ? 1 : 0)) == 0)
        return;
      this.m_UI.UI_DrawStringBold(Color.Yellow, "Directories and game manual created.", 0, gy2, new Color?());
      int gy3 = gy2 + 14;
      this.m_UI.UI_DrawStringBold(Color.Yellow, "Your save, high scores, and screenshots are in the game's directory:", 0, gy3, new Color?());
      int gy4 = gy3 + 14;
    ...
    private void HandleMainMenu()
    {
      ...
      {
        "New Game",
        flag2 ? "Load Saved Game" : "(no save found)",
        "Redefine keys",
        "Options",
        "Game Manual",
        "All Hints",
      ...
      do
      {
        ...
        int gy2 = gy1 + 28;
        this.DrawMenuOrOptions(currentChoice, Color.White, entries, Color.White, (string[]) null, gx1, ref gy2, 256);
        ...
        if (now.Month == 12 && now.Day >= 24 && now.Day <= 26)
        {
          for (int index = 0; index < 10; ++index)
          {
            ...
            int gy3 = this.m_Rules.Roll(0, 768);
            this.m_UI.UI_DrawImage("Actors\\santaman", gx2, gy3);
            this.m_UI.UI_DrawStringBold(Color.Snow, "* Merry Christmas *", gx2 - 60, gy3 - 10, new Color?());
          }
        }
        this.m_UI.UI_Repaint();
          ...
          case Keys.Return:
            switch (currentChoice)
            {
              ...
              case 1:
                ...
                {
                  int gy3 = gy2 + 28;
                  this.m_UI.UI_DrawStringBold(Color.Yellow, "Loading game, please wait...", gx1, gy3, new Color?());
                  this.m_UI.UI_Repaint();
    ...
    private bool HandleNewGameMode()
    {
      ...
      string[] values = new string[3]
      {
        ...
        "Don't get infected, and watch out for fresh corpses...",
        "The classic zombies experience."
      };
      bool flag1 = true;
      bool flag2 = false;
      int currentChoice = 0;
        ...
        switch (currentChoice)
        {
          case 0:
            strArray = new string[4]
            {
              ...
              "- All the different types of undeads.",
          ...
          case 2:
            strArray = new string[9]
            {
              ...
              "- Corpses will slowy rot... but may rise as undead if infected.",
              "",
              "NOTE: This mode forces some options OFF.",
    ...
    private bool HandleNewCharacterRace(DiceRoller roller, out bool isUndead)
    {
      ...
      do
      {
        ...
        int gy;
        int gx = gy = 0;
        this.m_UI.UI_DrawStringBold(Color.Yellow, string.Format("[{0}] New Character - Choose Race", (object) Session.DescGameMode(this.m_Session.GameMode)), gx, gy, new Color?());
        gy += 28;
          ...
          case Keys.Return:
            switch (currentChoice)
            {
              case 0:
                ...
                gy += 14;
                this.m_UI.UI_DrawStringBold(Color.White, string.Format("Race : {0}.", isUndead ? (object) "Undead" : (object) "Living"), gx, gy, new Color?());
                flag2 = true;
                flag1 = false;
                break;
              case 1:
    ...
    private bool HandleNewCharacterGender(DiceRoller roller, out bool isMale)
    {
      ...
      do
      {
        ...
        int gy1;
        int gx = gy1 = 0;
        this.m_UI.UI_DrawStringBold(Color.Yellow, string.Format("[{0}] New Living - Choose Gender", (object) Session.DescGameMode(this.m_Session.GameMode)), gx, gy1, new Color?());
        int gy2 = gy1 + 28;
        this.DrawMenuOrOptions(currentChoice, Color.White, entries, Color.LightGray, values, gx, ref gy2, 256);
        this.DrawFootnote(Color.White, "cursor to move, ENTER to select, ESC to cancel");
        this.m_UI.UI_Repaint();
          ...
          case Keys.Return:
            switch (currentChoice)
            {
              case 0:
                ...
                int gy3 = gy2 + 14;
                this.m_UI.UI_DrawStringBold(Color.White, string.Format("Gender : {0}.", isMale ? (object) "Male" : (object) "Female"), gx, gy3, new Color?());
                flag2 = true;
                flag1 = false;
                break;
              case 1:
    ...
    private bool HandleNewCharacterSkill(DiceRoller roller, out Skills.IDs skID)
    {
      ...
      string[] menuEntries = new string[idsArray.Length + 1];
      string[] skillDesc = new string[idsArray.Length + 1];
      ...
      for (int id = 0; id < 20; ++id)
      {
        ...
        if (!GameOptions.m_SanityGlobal && Skills.Name(idsArray[id]) == "Strong Psyche")
        {
          sanitySkillIndex = id + 1;
        }
        else
        {
          menuEntries[id + 1] = Skills.Name(idsArray[id]);
          skillDesc[id + 1] = string.Format("{0} max - {1}", (object) Skills.MaxSkillLevel(id), (object) this.DescribeSkillShort(idsArray[id]));
        }
      }
      if (!GameOptions.m_SanityGlobal)
      {
        menuEntries = ((IEnumerable<string>) menuEntries).Where<string>((Func<string, bool>) (w => w != menuEntries[sanitySkillIndex])).ToArray<string>();
        skillDesc = ((IEnumerable<string>) skillDesc).Where<string>((Func<string, bool>) (w => w != skillDesc[sanitySkillIndex])).ToArray<string>();
      }
      ...
      do
      {
        ...
        int gy;
        int gx = gy = 0;
        this.m_UI.UI_DrawStringBold(Color.Yellow, string.Format("[{0}] New {1} Character - Choose Starting Skill", (object) Session.DescGameMode(this.m_Session.GameMode), this.m_CharGen.IsMale ? (object) "Male" : (object) "Female"), gx, gy, new Color?());
        gy += 28;
        this.DrawMenuOrOptions(currentChoice, Color.White, menuEntries, Color.LightGray, skillDesc, gx, ref gy, 256);
        this.DrawFootnote(Color.White, "cursor to move, ENTER to select, ESC to cancel");
        this.m_UI.UI_Repaint();
        switch (this.m_UI.UI_WaitKey().KeyCode)
        {
          case Keys.Return:
            ...
            gy += 14;
            this.m_UI.UI_DrawStringBold(Color.White, string.Format("Skill : {0}.", (object) Skills.Name(skID)), gx, gy, new Color?());
            flag2 = true;
            flag1 = false;
            break;
          case Keys.Escape:
          ...
          case Keys.Up:
            ...
            currentChoice = menuEntries.Length - 1;
            break;
          case Keys.Down:
            currentChoice = (currentChoice + 1) % menuEntries.Length;
            break;
        }
      }
      while (flag1);
    ...
    private void HandleHiScores(bool saveToTextfile)
    {
      ...
      this.DrawHeader();
      int gy1 = num1 + 14;
      this.m_UI.UI_DrawStringBold(Color.Yellow, "High Scores", 0, gy1, new Color?());
      int gy2 = gy1 + 14;
      ...
      if (saveToTextfile)
      {
        textFile.Append(string.Format("ROGUE SURVIVOR: STILL ALIVE {0}", (object) SetupConfig.GAME_VERSION));
        textFile.Append("High Scores");
      ...
      for (int index = 0; index < this.m_HiScoreTable.Count; ++index)
      {
        ...
        Color color2 = color1;
        this.m_UI.UI_DrawStringBold(color2, "------------------------------------------------------------------------------------------------------------------------", 0, gy4, new Color?());
        int gy5 = gy4 + 14;
        ...
        this.m_UI.UI_DrawStringBold(color2, str, 0, gy5, new Color?());
        int gy6 = gy5 + 14;
        this.m_UI.UI_DrawStringBold(color2, string.Format("     | {0}.", (object) hiScore.SkillsDescription), 0, gy6, new Color?());
        int gy7 = gy6 + 14;
        this.m_UI.UI_DrawStringBold(color2, string.Format("     | {0}.", (object) hiScore.Death), 0, gy7, new Color?());
        gy4 = gy7 + 14;
        if (saveToTextfile)
        {
          textFile.Append("------------------------------------------------------------------------------------------------------------------------");
    ...
    {
      this.m_UI.UI_Clear(Color.Black);
      this.m_UI.UI_DrawStringBold(Color.White, "Loading high scores table...", 0, 0, new Color?());
      this.m_UI.UI_Repaint();
      ...
      this.m_UI.UI_Clear(Color.Black);
      this.m_UI.UI_DrawStringBold(Color.White, "Loading high scores table... done!", 0, 0, new Color?());
      this.m_UI.UI_Repaint();
    }
    ...
    {
      this.m_UI.UI_Clear(Color.Black);
      this.m_UI.UI_DrawStringBold(Color.White, "Saving high scores table...", 0, 0, new Color?());
      this.m_UI.UI_Repaint();
      HiScoreTable.Save(this.m_HiScoreTable, this.GetUserHiScoreFilePath());
      this.m_UI.UI_Clear(Color.Black);
      this.m_UI.UI_DrawStringBold(Color.White, "Saving high scores table... done!", 0, 0, new Color?());
      this.m_UI.UI_Repaint();
    }
    ...
    private void StartNewGame()
    {
      ...
      if (RogueGame.s_Options.IsAdvisorEnabled)
      {
        ...
        this.AddMessage(new djack.RogueSurvivor.Data.Message("You can disable the Advisor in the Options menu.", 0, Color.LightGreen));
      ...
      this.ClearMessages();
      this.AddMessage(new djack.RogueSurvivor.Data.Message(string.Format(isUndead ? "{0} rises..." : "{0} hears commotion...", (object) this.m_Player.Name), 0, Color.White));
      this.RedrawPlayScreen();
    ...
    private void HandleCredits()
    {
      ...
      int gy2 = gy1 + 28;
      this.m_UI.UI_DrawStringBold(Color.White, "Original programming, graphics & music by Jacques Ruiz (roguedjack)", 0, gy2, new Color?());
      int gy3 = gy2 + 28;
      ...
      int gy7 = gy6 + 14;
      this.m_UI.UI_DrawStringBold(Color.White, "Contact", 0, gy7, new Color?());
      int gy8 = gy7 + 14;
      this.m_UI.UI_DrawString(Color.White, "Email      : roguedjack@yahoo.fr", 0, gy8, new Color?());
      int gy9 = gy8 + 14;
      this.m_UI.UI_DrawString(Color.White, "Blog       : http://roguesurvivor.blogspot.com/", 0, gy9, new Color?());
      int gy10 = gy9 + 14;
      this.m_UI.UI_DrawString(Color.White, "Fans Forum : http://roguesurvivor.proboards.com/", 0, gy10, new Color?());
      int gy11 = gy10 + 42;
      this.m_UI.UI_DrawStringBold(Color.White, "'Staying Alive' modifications", 0, gy11, new Color?());
      int gy12 = gy11 + 14;
      this.m_UI.UI_DrawString(Color.White, "Programming", 0, gy12, new Color?());
      this.m_UI.UI_DrawString(Color.White, "- MP (http://roguesurvivor.proboards.com/user/180)", 256, gy12, new Color?());
      int gy13 = gy12 + 28;
      this.m_UI.UI_DrawString(Color.White, "Incorporates some of Deon's 'Deonapocalypse' tileset", 0, gy13, new Color?());
      this.m_UI.UI_DrawString(Color.White, "Grab the whole set: http://roguesurvivor.proboards.com/thread/264/alpha-9-deonapocalypse", 0, gy13 + 14, new Color?());
    ...
    {
      GameOptions options = RogueGame.s_Options;
      GameOptions.IDs[] idsArray = new GameOptions.IDs[38]
      {
        ...
        GameOptions.IDs.UI_SHOW_CORPSES,
      ...
      do
      {
        ...
        this.DrawHeader();
        int gy1 = num1 + 14;
        this.m_UI.UI_DrawStringBold(Color.Yellow, string.Format("[{0}] - Options", (object) Session.DescGameMode(this.m_Session.GameMode)), 0, gy1, new Color?());
        int gy2 = gy1 + 28;
        this.DrawMenuOrOptions(currentChoice, Color.White, entries, Color.LightGreen, values, gx, ref gy2, 400);
        int gy3 = gy2 + 14;
        this.m_UI.UI_DrawStringBold(Color.Red, "* Caution : increasing these values can make the game run slower and saving/loading longer.", gx, gy3, new Color?());
        int gy4 = gy3 + 14 + 14;
        this.m_UI.UI_DrawStringBold(Color.Yellow, string.Format("Difficulty Rating : {0}% as survivor / {1}% as undead.", (object) (int) (100.0 * (double) Scoring.ComputeDifficultyRating(RogueGame.s_Options, DifficultySide.FOR_SURVIVOR, 0)), (object) (int) (100.0 * (double) Scoring.ComputeDifficultyRating(RogueGame.s_Options, DifficultySide.FOR_UNDEAD, 0))), gx, gy4, new Color?());
        int gy5 = gy4 + 14;
        this.m_UI.UI_DrawStringBold(Color.White, "Scoring multiplier decreases with each reincarnation.", gx, gy5, new Color?());
        int num2 = gy5 + 28;
        this.DrawFootnote(Color.White, "Move cursor then left/right to change values, R to restore previous values, ESC to save and leave");
        this.m_UI.UI_Repaint();
        switch (this.m_UI.UI_WaitKey().KeyCode)
        {
          case Keys.Escape:
          ...
          case Keys.Left:
            switch (idsArray[currentChoice])
            {
              ...
              case GameOptions.IDs.UI_SHOW_CORPSES:
                RogueGame.s_Options.ShowCorpses = !RogueGame.s_Options.ShowCorpses;
                break;
              ...
              case GameOptions.IDs.GAME_SIMULATE_DISTRICTS:
                ...
                {
                  --RogueGame.s_Options.SimulateDistricts;
                  break;
                }
                break;
              ...
              case GameOptions.IDs.GAME_SANITY:
                RogueGame.s_Options.IsSanityEnabled = !RogueGame.s_Options.IsSanityEnabled;
                break;
              ...
              case GameOptions.IDs.GAME_UNDEADS_UPGRADE_DAYS:
                ...
                {
                  --RogueGame.s_Options.ZombifiedsUpgradeDays;
                  break;
                }
                break;
      ...
      while (flag);
      GameOptions.m_SanityGlobal = RogueGame.s_Options.IsSanityEnabled;
      this.SaveOptions();
    }
    ...
    private void HandleRedefineKeys()
    {
      ...
      do
      {
        ...
        int index1 = 0;
        Keys keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_N);
        string str1 = keys.ToString();
        strArray[index1] = str1;
        int index2 = 1;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_NE);
        string str2 = keys.ToString();
        strArray[index2] = str2;
        int index3 = 2;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_E);
        string str3 = keys.ToString();
        strArray[index3] = str3;
        int index4 = 3;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_SE);
        string str4 = keys.ToString();
        strArray[index4] = str4;
        int index5 = 4;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_S);
        string str5 = keys.ToString();
        strArray[index5] = str5;
        int index6 = 5;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_SW);
        string str6 = keys.ToString();
        strArray[index6] = str6;
        int index7 = 6;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_W);
        string str7 = keys.ToString();
        strArray[index7] = str7;
        int index8 = 7;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MOVE_NW);
        string str8 = keys.ToString();
        strArray[index8] = str8;
        int index9 = 8;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.WAIT_OR_SELF);
        string str9 = keys.ToString();
        strArray[index9] = str9;
        int index10 = 9;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.WAIT_LONG);
        string str10 = keys.ToString();
        strArray[index10] = str10;
        int index11 = 10;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ABANDON_GAME);
        string str11 = keys.ToString();
        strArray[index11] = str11;
        int index12 = 11;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ADVISOR);
        string str12 = keys.ToString();
        strArray[index12] = str12;
        int index13 = 12;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.BARRICADE_MODE);
        string str13 = keys.ToString();
        strArray[index13] = str13;
        int index14 = 13;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.BREAK_MODE);
        string str14 = keys.ToString();
        strArray[index14] = str14;
        int index15 = 14;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.BUILD_LARGE_FORTIFICATION);
        string str15 = keys.ToString();
        strArray[index15] = str15;
        int index16 = 15;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.BUILD_SMALL_FORTIFICATION);
        string str16 = keys.ToString();
        strArray[index16] = str16;
        int index17 = 16;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.CITY_INFO);
        string str17 = keys.ToString();
        strArray[index17] = str17;
        int index18 = 17;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.CLOSE_DOOR);
        string str18 = keys.ToString();
        strArray[index18] = str18;
        int index19 = 18;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.FIRE_MODE);
        string str19 = keys.ToString();
        strArray[index19] = str19;
        int index20 = 19;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.GIVE_ITEM);
        string str20 = keys.ToString();
        strArray[index20] = str20;
        int index21 = 20;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.HELP_MODE);
        string str21 = keys.ToString();
        strArray[index21] = str21;
        int index22 = 21;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.HINTS_SCREEN_MODE);
        string str22 = keys.ToString();
        strArray[index22] = str22;
        int index23 = 22;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.INITIATE_TRADE);
        string str23 = keys.ToString();
        strArray[index23] = str23;
        int index24 = 23;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_0);
        string str24 = keys.ToString();
        strArray[index24] = str24;
        int index25 = 24;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_1);
        string str25 = keys.ToString();
        strArray[index25] = str25;
        int index26 = 25;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_2);
        string str26 = keys.ToString();
        strArray[index26] = str26;
        int index27 = 26;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_3);
        string str27 = keys.ToString();
        strArray[index27] = str27;
        int index28 = 27;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_4);
        string str28 = keys.ToString();
        strArray[index28] = str28;
        int index29 = 28;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_5);
        string str29 = keys.ToString();
        strArray[index29] = str29;
        int index30 = 29;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_6);
        string str30 = keys.ToString();
        strArray[index30] = str30;
        int index31 = 30;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_7);
        string str31 = keys.ToString();
        strArray[index31] = str31;
        int index32 = 31;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_8);
        string str32 = keys.ToString();
        strArray[index32] = str32;
        int index33 = 32;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ITEM_SLOT_9);
        string str33 = keys.ToString();
        strArray[index33] = str33;
        int index34 = 33;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.LEAD_MODE);
        string str34 = keys.ToString();
        strArray[index34] = str34;
        int index35 = 34;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.LOAD_GAME);
        string str35 = keys.ToString();
        strArray[index35] = str35;
        int index36 = 35;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MARK_ENEMIES_MODE);
        string str36 = keys.ToString();
        strArray[index36] = str36;
        int index37 = 36;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.MESSAGE_LOG);
        string str37 = keys.ToString();
        strArray[index37] = str37;
        int index38 = 37;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.OPTIONS_MODE);
        string str38 = keys.ToString();
        strArray[index38] = str38;
        int index39 = 38;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ORDER_MODE);
        string str39 = keys.ToString();
        strArray[index39] = str39;
        int index40 = 39;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.PUSH_MODE);
        string str40 = keys.ToString();
        strArray[index40] = str40;
        int index41 = 40;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.QUIT_GAME);
        string str41 = keys.ToString();
        strArray[index41] = str41;
        int index42 = 41;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.KEYBINDING_MODE);
        string str42 = keys.ToString();
        strArray[index42] = str42;
        int index43 = 42;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.RUN_TOGGLE);
        string str43 = keys.ToString();
        strArray[index43] = str43;
        int index44 = 43;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.SAVE_GAME);
        string str44 = keys.ToString();
        strArray[index44] = str44;
        int index45 = 44;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.SCREENSHOT);
        string str45 = keys.ToString();
        strArray[index45] = str45;
        int index46 = 45;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.SHOUT);
        string str46 = keys.ToString();
        strArray[index46] = str46;
        int index47 = 46;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.SLEEP);
        string str47 = keys.ToString();
        strArray[index47] = str47;
        int index48 = 47;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.SWITCH_PLACE);
        string str48 = keys.ToString();
        strArray[index48] = str48;
        int index49 = 48;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.USE_EXIT);
        string str49 = keys.ToString();
        strArray[index49] = str49;
        int index50 = 49;
        keys = RogueGame.s_KeyBindings.Get(PlayerCommand.USE_SPRAY);
        string str50 = keys.ToString();
        strArray[index50] = str50;
...
label_39:
    ...
    private void AdvancePlay(Map map, RogueGame.SimFlags sim)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (!RogueGame.s_Options.IsSanityEnabled)
            return;
    ...
    {
      if ((uint) (sim & RogueGame.SimFlags.LODETAIL_TURN) <= 0U)
      {
          ...
          if (flag1 && map.CountCorpses > 0)
          {
            ...
            if (corpseList1.Count > 0)
            {
              ...
              foreach (Corpse corpse in corpseList1)
              {
                ...
                {
                  double num = (double) corpse.HitPoints / (double) corpse.MaxHitPoints;
        ...
        foreach (Actor actor in map.Actors)
        {
          ...
          if (actor.Model.Abilities.HasToSleep)
          {
            ...
            if (actor.IsSleeping)
            {
              ...
              if ((this.m_Rules.IsActorHungry(actor) ? 1 : (actor.SleepPoints >= this.m_Rules.ActorMaxSleep(actor) ? 1 : 0)) != 0)
                this.DoWakeUp(actor);
          ...
          if (actor.Model.Abilities.HasSanity && RogueGame.s_Options.IsSanityEnabled && --actor.Sanity <= 0)
            actor.Sanity = 0;
          if (actor.HasLeader)
          {
    ...
    private void FireEvent_RefugeesWave(District district)
    {
      ...
      lock (this.m_Session)
      {
        UniqueActor[] all = Array.FindAll<UniqueActor>(this.m_Session.UniqueActors.ToArray(), (Predicate<UniqueActor>) (a =>
        {
        ...
        if (all == null || all.Length == 0)
          return;
        int index = this.m_Rules.Roll(0, all.Length);
        this.FireEvent_UniqueActorArrive(district.EntryMap, all[index]);
      }
    }
    ...
    private void FireEvent_UniqueActorArrive(Map map, UniqueActor unique)
    {
      ...
      if (map1 != map2 || this.m_Player.IsSleeping || this.m_Player.Model.Abilities.IsUndead)
        return;
      if (unique.EventMessage != null)
      {
        ...
        string eventText = "Seems to come from";
        location = unique.TheActor.Location;
        Point position = location.Position;
        this.AddMessage(this.MakePlayerCentricMessage(eventText, position));
        this.AddMessagePressEnter();
        this.ClearMessages();
      }
    ...
    private bool CheckForEvent_NationalGuard(Map map)
    {
      ...
      return (double) this.CountUndeads(map) / (double) num * ((double) RogueGame.s_Options.NatGuardFactor / 100.0) >= 5.0;
    }
    ...
    private void FireEvent_NationalGuard(Map map)
    {
      ...
      if (actor != null)
      {
        for (int index = 0; index < 4; ++index)
        {
          ...
          Point position = location.Position;
          Actor other = this.SpawnNewNatGuardTrooper(map1, position);
          if (other != null)
      ...
      this.NotifyOrderablesAI(map2, (RaidType) num, position1);
      Map map3 = map;
      location = this.m_Player.Location;
      Map map4 = location.Map;
      if (map3 == map4 && !this.m_Player.IsSleeping && !this.m_Player.Model.Abilities.IsUndead)
      {
        this.m_MusicManager.StopAll();
        ...
        string eventText = "Soldiers seem to come from";
        location = actor.Location;
        Point position2 = location.Position;
        this.AddMessage(this.MakePlayerCentricMessage(eventText, position2));
        this.AddMessagePressEnter();
        this.ClearMessages();
      }
      Map map5 = map;
      location = this.m_Player.Location;
      Map map6 = location.Map;
      if (map5 != map6)
        return;
    ...
    private bool CheckForEvent_ArmySupplies(Map map)
    {
      ...
      return (double) (1 + this.CountFoodItemsNutrition(map)) / (double) num < (double) RogueGame.s_Options.SuppliesDropFactor / 100.0 * 288.0;
    }
    ...
    private void FireEvent_BlackOpsRaid(Map map)
    {
      ...
      if (map1 == map2 && !this.m_Player.IsSleeping && !this.m_Player.Model.Abilities.IsUndead)
      {
        ...
        string eventText = "The chopper has dropped something";
        location = actor.Location;
        Point position = location.Position;
        this.AddMessage(this.MakePlayerCentricMessage(eventText, position));
        this.AddMessagePressEnter();
    ...
    private void FireEvent_BandOfSurvivors(Map map)
    {
      ...
      if (map1 == map2 && !this.m_Player.IsSleeping && !this.m_Player.Model.Abilities.IsUndead)
      {
        ...
        string eventText = "A van has stopped";
        location = actor.Location;
        Point position = location.Position;
        this.AddMessage(this.MakePlayerCentricMessage(eventText, position));
        this.AddMessagePressEnter();
    ...
    private void HandlePlayerActor(Actor player)
    {
      ...
      do
      {
        ...
        {
          Keys keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ADVISOR);
          string str1;
          if (keys.ToString() == "H, Shift")
          {
            str1 = "HINT AVAILABLE PRESS <Shift+H>";
          }
          else
          {
            string format = "HINT AVAILABLE PRESS <{0}>";
            keys = RogueGame.s_KeyBindings.Get(PlayerCommand.ADVISOR);
            string str2 = keys.ToString();
            str1 = string.Format(format, (object) str2);
          }
          string[] lines = new string[1]{ str1 };
          Color white1 = Color.White;
          Color white2 = Color.White;
          Color black = Color.Black;
          location = this.m_Player.Location;
          int x = location.Position.X - 3;
          location = this.m_Player.Location;
          int y = location.Position.Y - 1;
          Point screen = this.MapToScreen(x, y);
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayPopup(lines, white1, white2, black, screen));
        }
        this.RedrawPlayScreen();
          ...
          else
          {
            switch (command)
            {
              ...
              case PlayerCommand.USE_EXIT:
                ...
                Point position = location.Position;
                flag1 = !this.DoUseExit(actor, position);
                break;
...
label_94:;
      ...
      this.UpdatePlayerFOV(player);
      location = player.Location;
      this.ComputeViewRect(location.Position);
    ...
    private void HandleHelpMode()
    {
      ...
      else
      {
        ...
        do
        {
          ...
          this.m_UI.UI_DrawStringBold(Color.White, "---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+", 0, gy2, new Color?());
          int gy3 = gy2 + 14;
          int manualLine1 = this.m_ManualLine;
          do
          {
            if (!(formatedLines[manualLine1] == "<SECTION>"))
            {
              this.m_UI.UI_DrawStringBold(Color.LightGray, formatedLines[manualLine1], 0, gy3, new Color?());
              gy3 += 14;
            }
            ++manualLine1;
          }
          while (manualLine1 < formatedLines.Count && gy3 < 740);
          ...
          if (choiceNumber >= 0)
          {
            ...
            {
              int manualLine2 = this.m_ManualLine;
              int num3 = 0;
              for (this.m_ManualLine = 0; num3 < choiceNumber && this.m_ManualLine < formatedLines.Count; ++this.m_ManualLine)
              {
                if (formatedLines[this.m_ManualLine] == "<SECTION>")
                  ++num3;
              }
              if (this.m_ManualLine >= formatedLines.Count)
                this.m_ManualLine = manualLine2;
            }
          }
          else
          {
    ...
    private void HandleCityInfo()
    {
      ...
      else
      {
        ...
        {
          int num3 = index;
          worldPosition = this.m_Player.Location.Map.District.WorldPosition;
          int y = worldPosition.Y;
          Color color = num3 == y ? Color.LightGreen : Color.White;
        ...
        for (int index = 0; index < this.m_Session.World.Size; ++index)
        {
          ...
          this.m_UI.UI_DrawStringBold(num3 == x ? Color.LightGreen : Color.White, string.Format("..{0}..", (object) (char) (65 + index)), 32 + index * 48, gy2, new Color?());
        }
        int num4 = gy2 + 14;
        int num5 = 32;
        int num6 = num4;
        for (int index1 = 0; index1 < this.m_Session.World.Size; ++index1)
        {
          for (int index2 = 0; index2 < this.m_Session.World.Size; ++index2)
          {
            ...
            for (int index3 = 0; index3 < 5; ++index3)
              text += ch.ToString();
            this.m_UI.UI_DrawStringBold(color, text, num5 + index2 * 48, num6 + index1 * 3 * 14, new Color?());
            this.m_UI.UI_DrawStringBold(color, string.Format("{0}{1}{2}", (object) ch, (object) str, (object) ch), num5 + index2 * 48, num6 + (index1 * 3 + 1) * 14, new Color?());
            this.m_UI.UI_DrawStringBold(color, text, num5 + index2 * 48, num6 + (index1 * 3 + 2) * 14, new Color?());
          }
        }
        int num7 = this.m_Session.World.Size / 2;
        for (int index = 1; index < this.m_Session.World.Size; ++index)
          this.m_UI.UI_DrawStringBold(Color.White, "=", num5 + index * 48 - 8, num6 + num7 * 3 * 14 + 14, new Color?());
        int gy3 = num4 + (this.m_Session.World.Size * 3 + 1) * 14;
    ...
    private bool HandleMouseInventory(Point mousePos, MouseButtons? mouseButtons, out bool hasDoneAction)
    {
      ...
      if (inventoryItem != null)
      {
        ...
        {
          MouseButtons? nullable = mouseButtons;
          MouseButtons mouseButtons1 = MouseButtons.Left;
          if ((nullable.GetValueOrDefault() == mouseButtons1 ? (nullable.HasValue ? 1 : 0) : 0) != 0)
          {
            hasDoneAction = this.OnLMBItem(inv, inventoryItem);
          }
          else
          {
            nullable = mouseButtons;
            MouseButtons mouseButtons2 = MouseButtons.Right;
            if ((nullable.GetValueOrDefault() == mouseButtons2 ? (nullable.HasValue ? 1 : 0) : 0) != 0)
    ...
    private bool OnRMBCorpse(Corpse c)
    {
      ...
      {
        this.AddMessage(this.MakeErrorMessage(string.Format("Cannot butcher corpses in STD game mode")));
        return false;
      }
      string reason1;
    ...
    private bool HandlePlayerReviveCorpse(Actor player, Point mousePos)
    {
      ...
      if (!Rules.HasInfection(this.m_Session.GameMode))
      {
        this.AddMessage(this.MakeErrorMessage(string.Format("Cannot revive corpses in STD game mode")));
        return false;
      }
    ...
    public void DoReviveCorpse(Actor actor, Corpse corpse)
    {
      ...
      location = actor.Location;
      Point position1 = location.Position;
      Predicate<Point> predicateFn = (Predicate<Point>) (pt => map.GetActorAt(pt) == null && map.GetMapObjectAt(pt) == null);
      List<Point> pointList = map1.FilterAdjacentInMap(position1, predicateFn);
      if (pointList == null)
      {
        if (!player)
          return;
      ...
      {
        Point position2 = pointList[this.m_Rules.Roll(0, pointList.Count)];
        ...
        if (this.m_Rules.RollChance(chance))
        {
          ...
          map.PlaceActorAt(corpse.DeadGuy, position2);
          if (player)
    ...
    private bool HandlePlayerGiveItem(Actor player, Point screen)
    {
      ...
      do
      {
        ...
        {
          Location location = player.Location;
          Point point = location.Position + direction;
          location = player.Location;
          if (location.Map.IsInBounds(point))
          {
            location = player.Location;
            Actor actorAt = location.Map.GetActorAt(point);
            if (actorAt != null)
            {
              string reason;
    ...
    private bool HandlePlayerCloseDoor(Actor player)
    {
      ...
      do
      {
        ...
        else if (direction != Direction.NEUTRAL)
        {
          ...
          {
            location = player.Location;
            MapObject mapObjectAt = location.Map.GetMapObjectAt(point);
    ...
    private bool HandlePlayerFireMode(Actor player)
    {
      ...
      ItemRangedWeapon equippedWeapon = player.GetEquippedWeapon() as ItemRangedWeapon;
      ...
      do
      {
        ...
        int num = this.m_Rules.GridDistance(player.Location.Position, actor.Location.Position);
        this.ClearOverlays();
        ...
        string imageID = flag3 ? (num <= attack.EfficientRange ? "Icons\\line_clear" : "Icons\\line_bad") : "Icons\\line_blocked";
        ...
        int command = (int) InputTranslator.KeyToCommand(key);
    ...
    private bool HandlePlayerThrowGrenade(Actor player)
    {
      bool flag1 = true;
      bool flag2 = false;
      ItemGrenade equippedWeapon1 = player.GetEquippedWeapon() as ItemGrenade;
      ItemGrenadePrimed equippedWeapon2 = player.GetEquippedWeapon() as ItemGrenadePrimed;
      ...
      Map map = location.Map;
      location = player.Location;
      Point point1 = location.Position;
    ...
    private bool HandlePlayerPushObject(Actor player, MapObject mapObj)
    {
      ...
      do
      {
        ...
        {
          Location location = mapObj.Location;
          Point point = location.Position + direction;
          location = player.Location;
          if (location.Map.IsInBounds(point))
          {
    ...
    private bool HandlePlayerTag(Actor player)
    {
      bool flag1 = true;
      bool flag2 = false;
      ItemSprayPaint equippedItem = player.GetEquippedItem(DollPart.LEFT_HAND) as ItemSprayPaint;
      if (equippedItem == null)
      {
      ...
      if (equippedItem.PaintQuantity <= 0)
      {
      ...
      do
      {
        ...
        else if (direction != Direction.NEUTRAL)
        {
          ...
          if (location.Map.IsInBounds(point))
          {
            location = player.Location;
            string reason;
            if (this.CanTag(location.Map, point, out reason))
            {
              this.DoTag(player, equippedItem, point);
              flag1 = false;
              flag2 = true;
            }
            else
    ...
    private bool HandlePlayerOrderMode(Actor player)
    {
      ...
      foreach (Actor follower in player.Followers)
      {
        ...
        HashSet<Point> pointSet = pointSetArray[index1];
        Location location = player.Location;
        Point position1 = location.Position;
        int num;
        if (pointSet.Contains(position1))
        {
          HashSet<Point> playerFov = this.m_PlayerFOV;
          location = follower.Location;
          Point position2 = location.Position;
          num = playerFov.Contains(position2) ? 1 : 0;
        }
        else
          num = 0;
        bool flag1 = num != 0;
      ...
      {
        int num = this.HandlePlayerOrderFollower(player, actorArray[0]) ? 1 : 0;
        this.ClearOverlays();
        this.ClearMessages();
        return num != 0;
      }
    ...
    private bool HandlePlayerOrderFollowerToBuildFortification(Actor player, Actor follower, HashSet<Point> followerFOV, bool isLarge)
    {
      ...
      do
      {
        ...
        if (nullable.HasValue)
        {
          ...
          int y = point.Y;
          Rectangle rect = new Rectangle(this.MapToScreen(x, y), new Size(32, 32));
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(color2, rect));
        }
        this.ClearMessages();
      ...
      do
      {
        ...
        else
        {
          ...
          if (map1.IsInBounds(map2) && this.IsInViewRect(map2))
          {
            if (this.IsVisibleToPlayer(map1, map2) && followerFOV.Contains(map2))
            {
              DoorWindow mapObjectAt = map1.GetMapObjectAt(map2) as DoorWindow;
              if (mapObjectAt != null)
              {
                string reason;
                if (this.m_Rules.CanActorBarricadeDoor(follower, mapObjectAt, out reason))
                {
                  nullable = new Point?(map2);
                  color1 = Color.LightGreen;
                  if (mouseButtons.HasValue && mouseButtons.Value == MouseButtons.Left)
                  {
                    this.DoGiveOrderTo(player, follower, new ActorOrder(toTheMax ? ActorTasks.BARRICADE_MAX : ActorTasks.BARRICADE_ONE, mapObjectAt.Location));
                    flag1 = false;
                    flag2 = true;
                  }
                }
                else
                {
                  ...
                  if (mouseButtons.HasValue && mouseButtons.Value == MouseButtons.Left)
                  {
                    this.AddMessage(this.MakeErrorMessage(string.Format("Can't barricade {0} : {1}.", (object) mapObjectAt.TheName, (object) reason)));
                    this.AddMessagePressEnter();
                  }
                }
              }
    ...
    private bool HandlePlayerOrderFollowerToPatrol(Actor player, Actor follower, HashSet<Point> followerFOV)
    {
      ...
      do
      {
        ...
        if (nullable.HasValue)
        {
          ...
          point = nullable.Value;
          int y1 = point.Y;
          Rectangle rect = new Rectangle(this.MapToScreen(x1, y1), new Size(32, 32));
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(color2, rect));
          Map map2 = map1;
          point = nullable.Value;
          int x2 = point.X;
          point = nullable.Value;
          int y2 = point.Y;
          List<Zone> zonesAt = map2.GetZonesAt(x2, y2);
          if (zonesAt != null && zonesAt.Count > 0)
          {
            string[] strArray = new string[zonesAt.Count + 1];
            strArray[0] = "Zone(s) here :";
            for (int index = 0; index < zonesAt.Count; ++index)
              strArray[index + 1] = string.Format("- {0}", (object) zonesAt[index].Name);
            string[] lines = strArray;
            Color white1 = Color.White;
            Color white2 = Color.White;
            Color popupFillcolor = this.POPUP_FILLCOLOR;
            point = nullable.Value;
            int x3 = point.X + 1;
            point = nullable.Value;
            int y3 = point.Y + 1;
            Point screen = this.MapToScreen(x3, y3);
            this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayPopup(lines, white1, white2, popupFillcolor, screen));
          }
        }
        this.ClearMessages();
    ...
    private bool HandlePlayerOrderFollowerToGiveItems(Actor player, Actor follower)
    {
      ...
      Map map1 = player.Location.Map;
      Location location = follower.Location;
      Map map2 = location.Map;
      if (map1 == map2)
      {
        Rules rules = this.m_Rules;
        location = player.Location;
        Point position1 = location.Position;
        location = follower.Location;
        Point position2 = location.Position;
    ...
    private bool IsAdvisorHintAppliable(AdvisorHint hint)
    {
      ...
      switch (hint)
      {
        ...
        case AdvisorHint.WEAPON_FIRE:
          ItemRangedWeapon equippedWeapon = this.m_Player.GetEquippedWeapon() as ItemRangedWeapon;
          if (equippedWeapon == null)
            return false;
          return equippedWeapon.Ammo >= 0;
        ...
        case AdvisorHint.GRENADE:
          ...
          if (inventory6 == null || inventory6.IsEmpty)
            return false;
          return inventory6.HasItemOfType(typeof (ItemGrenade));
        ...
        case AdvisorHint.CORPSE_DRAG_MOVE:
          return map.HasAnyAdjacentInMap(position, (Predicate<Point>) (pt =>
          {
            ...
            if (mapObjectAt == null)
              return false;
            return this.m_Rules.IsOpenableFor(this.m_Player, mapObjectAt);
          }));
        ...
        case AdvisorHint.BARRICADE:
          return map.HasAnyAdjacentInMap(position, (Predicate<Point>) (pt =>
          {
            ...
            if (mapObjectAt == null)
              return false;
            return this.m_Rules.CanActorBarricadeDoor(this.m_Player, mapObjectAt);
          }));
    ...
    private void GetAdvisorHintText(AdvisorHint hint, out string title, out string[] body)
    {
      switch (hint)
      {
        ...
        case AdvisorHint.BUILD_FORTIFICATION:
          ...
          int index1 = 2;
          string format1 = "To BUILD SMALL FORTIFICATIONS : <{0}>.";
          Keys keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.BUILD_SMALL_FORTIFICATION);
          string str1 = keys1.ToString();
          string str2 = string.Format(format1, (object) str1);
          strArray1[index1] = str2;
          int index2 = 3;
          string format2 = "To BUILD LARGE FORTIFICATIONS : <{0}>.";
          keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.BUILD_LARGE_FORTIFICATION);
          string str3 = keys1.ToString();
          string str4 = string.Format(format2, (object) str3);
        ...
        case AdvisorHint.LEADING_GIVE_ORDERS:
          ...
          int index3 = 2;
          string format3 = "To GIVE ORDERS : <{0}>.";
          Keys keys2 = RogueGame.s_KeyBindings.Get(PlayerCommand.ORDER_MODE);
          string str5 = keys2.ToString();
          string str6 = string.Format(format3, (object) str5);
          strArray2[index3] = str6;
          int index4 = 3;
          string format4 = "To FIRE YOUR FOLLOWER : <{0}>.";
          keys2 = RogueGame.s_KeyBindings.Get(PlayerCommand.LEAD_MODE);
          string str7 = keys2.ToString();
          string str8 = string.Format(format4, (object) str7);
          strArray2[index4] = str8;
          int index5 = 4;
          string format5 = "To SWITCH PLACE : <{0}>.";
          keys2 = RogueGame.s_KeyBindings.Get(PlayerCommand.SWITCH_PLACE);
          string str9 = keys2.ToString();
          string str10 = string.Format(format5, (object) str9);
          strArray2[index5] = str10;
          local2 = strArray2;
          break;
        case AdvisorHint.LEADING_SWITCH_PLACE:
        ...
        case AdvisorHint.GAME_SAVE_LOAD:
          ...
          int index6 = 2;
          string format6 = "To SAVE THE GAME : <{0}>.";
          Keys keys3 = RogueGame.s_KeyBindings.Get(PlayerCommand.SAVE_GAME);
          string str11 = keys3.ToString();
          string str12 = string.Format(format6, (object) str11);
          strArray3[index6] = str12;
          int index7 = 3;
          string format7 = "To LOAD THE GAME : <{0}>.";
          keys3 = RogueGame.s_KeyBindings.Get(PlayerCommand.LOAD_GAME);
          string str13 = keys3.ToString();
          string str14 = string.Format(format7, (object) str13);
          strArray3[index7] = str14;
          local3 = strArray3;
          break;
        case AdvisorHint.CITY_INFORMATION:
    ...
    private string[] DescribeActor(Actor actor)
    {
      ...
      AIController controller = actor.Controller as AIController;
      if (controller != null && controller.Order != null)
        stringList.Add(string.Format("Order : {0}.", (object) controller.Order.ToString()));
      if (actor.HasLeader)
      {
        if (actor.Leader.IsPlayer)
        {
          ...
          OrderableAI orderableAi = controller as OrderableAI;
    ...
    {
      BaseAI controller = follower.Controller as BaseAI;
      return (controller.Order != null ? controller.Order.ToString() : "(no orders)") + string.Format("(trust:{0})", (object) follower.TrustInLeader);
    }
    ...
    private string[] DescribeCorpseLong(Corpse c, bool isInPlayerTile)
    {
      ...
      if (Rules.HasInfection(this.m_Session.GameMode))
      {
        string str2 = string.Format("<need Necrology {0}>", (object) Rules.SKILL_NECROLOGY_LEVEL_FOR_INFECTION);
        ...
        string str3 = string.Format("<need Necrology> {0}>", (object) Rules.SKILL_NECROLOGY_LEVEL_FOR_RISE);
      ...
      if (Rules.HasInfection(this.m_Session.GameMode))
      {
        string str2 = string.Format("<need Medic> {0}>", (object) Rules.SKILL_MEDIC_LEVEL_FOR_REVIVE_EST);
        if (this.m_Player.Sheet.SkillTable.GetSkillLevel(14) >= Rules.SKILL_MEDIC_LEVEL_FOR_REVIVE_EST)
        {
          ...
          str2 = num != 0 ? (num >= 5 ? (num >= 20 ? (num >= 40 ? (num >= 60 ? (num >= 80 ? (num >= 99 ? "6/6 - certain" : "5/6 - most likely") : "4/6 - very likely") : "3/6 - likely") : "2/6 - possible") : "1/6 - unlikely") : "0/6 - extremely unlikely") : "impossible";
        }
        stringList.Add(string.Format("Revive : {0}.", (object) str2));
      }
      if (isInPlayerTile)
      {
        stringList.Add(" ");
        stringList.Add("----");
        stringList.Add("LMB to start/stop dragging.");
        if (Rules.HasInfection(this.m_Session.GameMode))
        {
          stringList.Add(string.Format("RMB to {0}.", this.m_Player.Model.Abilities.IsUndead ? (object) "eat" : (object) "butcher"));
          if (!this.m_Player.Model.Abilities.IsUndead)
          {
    ...
    private string[] DescribeItemLong(Item it, bool isPlayerInventory)
    {
      ...
      if (it.Model.IsStackable)
        stringList1.Add(string.Format("{0} {1}/{2}", (object) this.DescribeItemShort(it), (object) it.Quantity, (object) it.Model.StackingLimit));
      else
        stringList1.Add(this.DescribeItemShort(it));
      if (it.Model.IsUnbreakable)
        stringList1.Add("Unbreakable.");
      string str1 = (string) null;
      Keys keys1;
      if (it is ItemWeapon)
      {
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemWeapon(it as ItemWeapon));
        if (it is ItemRangedWeapon)
        {
          string format = "to fire : <{0}>.";
          keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.FIRE_MODE);
          string str2 = keys1.ToString();
          str1 = string.Format(format, (object) str2);
        }
      }
      else if (it is ItemFood)
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemFood(it as ItemFood));
      else if (it is ItemMedicine)
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemMedicine(it as ItemMedicine));
      else if (it is ItemBarricadeMaterial)
      {
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemBarricadeMaterial(it as ItemBarricadeMaterial));
        string format = "to use : <{0}>/<{1}>/<{2}>.";
        Keys keys2 = RogueGame.s_KeyBindings.Get(PlayerCommand.BARRICADE_MODE);
        string str2 = keys2.ToString();
        keys2 = RogueGame.s_KeyBindings.Get(PlayerCommand.BUILD_SMALL_FORTIFICATION);
        string str3 = keys2.ToString();
        keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.BUILD_LARGE_FORTIFICATION);
        string str4 = keys1.ToString();
        str1 = string.Format(format, (object) str2, (object) str3, (object) str4);
      }
      else if (it is ItemBodyArmor)
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemBodyArmor(it as ItemBodyArmor));
      else if (it is ItemSprayPaint)
      {
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemSprayPaint(it as ItemSprayPaint));
        string format = "to spray : <{0}>.";
        keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.USE_SPRAY);
        string str2 = keys1.ToString();
        str1 = string.Format(format, (object) str2);
      }
      else if (it is ItemSprayScent)
      {
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemSprayScent(it as ItemSprayScent));
        string format = "to spray : <{0}>.";
        keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.USE_SPRAY);
        string str2 = keys1.ToString();
        str1 = string.Format(format, (object) str2);
        ...
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemLight(it as ItemLight));
      else if (it is ItemTracker)
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemTracker(it as ItemTracker));
      else if (it is ItemAmmo)
      {
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemAmmo(it as ItemAmmo));
        str1 = "to reload : left-click.";
      }
      else if (it is ItemExplosive)
      {
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemExplosive(it as ItemExplosive));
        string format = "to throw : <{0}>.";
        keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.FIRE_MODE);
        string str2 = keys1.ToString();
        str1 = string.Format(format, (object) str2);
      }
      else if (it is ItemTrap)
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemTrap(it as ItemTrap));
      else if (it is ItemEntertainment)
        stringList1.AddRange((IEnumerable<string>) this.DescribeItemEntertainment(it as ItemEntertainment));
      stringList1.Add(" ");
      stringList1.Add(it.Model.FlavorDescription);
      if (isPlayerInventory)
      {
        stringList1.Add(" ");
        stringList1.Add("----");
        List<string> stringList2 = stringList1;
        string format1 = "to give : <{0}>.";
        keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.GIVE_ITEM);
        string str2 = keys1.ToString();
        string str3 = string.Format(format1, (object) str2);
        stringList2.Add(str3);
        List<string> stringList3 = stringList1;
        string format2 = "to trade : <{0}>.";
        keys1 = RogueGame.s_KeyBindings.Get(PlayerCommand.INITIATE_TRADE);
        string str4 = keys1.ToString();
        string str5 = string.Format(format2, (object) str4);
    ...
    {
      List<string> stringList1 = new List<string>();
      ItemExplosiveModel model1 = ex.Model as ItemExplosiveModel;
      ItemPrimedExplosive itemPrimedExplosive = ex as ItemPrimedExplosive;
      stringList1.Add("> explosive");
      if (model1.BlastAttack.CanDamageObjects)
        stringList1.Add("Can damage objects.");
      if (model1.BlastAttack.CanDestroyWalls)
        stringList1.Add("Can destroy walls.");
      if (itemPrimedExplosive != null)
        stringList1.Add(string.Format("Fuse          : {0} turn(s) left!", (object) itemPrimedExplosive.FuseTimeLeft));
      else
        stringList1.Add(string.Format("Fuse          : {0} turn(s)", (object) model1.FuseDelay));
      List<string> stringList2 = stringList1;
      string format = "Blast radius  : {0}";
      BlastAttack blastAttack = model1.BlastAttack;
      // ISSUE: variable of a boxed type
      __Boxed<int> radius1 = (ValueType) blastAttack.Radius;
      string str = string.Format(format, (object) radius1);
      stringList2.Add(str);
      StringBuilder stringBuilder = new StringBuilder();
      int distance = 0;
      while (true)
      {
        int num = distance;
        blastAttack = model1.BlastAttack;
        int radius2 = blastAttack.Radius;
        if (num <= radius2)
        {
          stringBuilder.Append(string.Format("{0};", (object) this.m_Rules.BlastDamage(distance, model1.BlastAttack)));
          ++distance;
        }
        else
          break;
      }
      stringList1.Add(string.Format("Blast damages : {0}", (object) stringBuilder.ToString()));
      ItemGrenade itemGrenade = ex as ItemGrenade;
      if (itemGrenade != null)
      {
        stringList1.Add("> grenade");
        ItemGrenadeModel model2 = itemGrenade.Model as ItemGrenadeModel;
        int num = this.m_Rules.ActorMaxThrowRange(this.m_Player, model2.MaxThrowDistance);
        if (num != model2.MaxThrowDistance)
          stringList1.Add(string.Format("Throwing rng  : {0} ({1})", (object) num, (object) model2.MaxThrowDistance));
        else
          stringList1.Add(string.Format("Throwing rng  : {0}", (object) num));
      }
      if (itemPrimedExplosive != null)
        stringList1.Add("PRIMED AND READY TO EXPLODE!");
      return stringList1.ToArray();
    }
    ...
    {
      List<string> stringList1 = new List<string>();
      ItemWeaponModel model1 = w.Model as ItemWeaponModel;
      stringList1.Add("> weapon");
      stringList1.Add(string.Format("Atk : +{0}", (object) model1.Attack.HitValue));
      stringList1.Add(string.Format("Dmg : +{0}", (object) model1.Attack.DamageValue));
      stringList1.Add(string.Format("Sta : -{0}", (object) model1.Attack.StaminaPenalty));
      ItemMeleeWeapon itemMeleeWeapon = w as ItemMeleeWeapon;
      if (itemMeleeWeapon != null)
      {
        if (itemMeleeWeapon.IsFragile)
          stringList1.Add("Breaks easily.");
      }
      else
      {
        ...
        {
          ItemRangedWeaponModel model2 = w.Model as ItemRangedWeaponModel;
          if (model2.IsFireArm)
            stringList1.Add("> firearm");
          else if (model2.IsBow)
            stringList1.Add("> bow");
          else
            stringList1.Add("> ranged weapon");
          List<string> stringList2 = stringList1;
          string format = "Rng  : {0}-{1}";
          Attack attack = model2.Attack;
          // ISSUE: variable of a boxed type
          __Boxed<int> range = (ValueType) attack.Range;
          attack = model2.Attack;
          // ISSUE: variable of a boxed type
          __Boxed<int> efficientRange = (ValueType) attack.EfficientRange;
          string str = string.Format(format, (object) range, (object) efficientRange);
          stringList2.Add(str);
          if (itemRangedWeapon.Ammo < model2.MaxAmmo)
            stringList1.Add(string.Format("Amo  : {0}/{1}", (object) itemRangedWeapon.Ammo, (object) model2.MaxAmmo));
          else
            stringList1.Add(string.Format("Amo  : {0} MAX", (object) itemRangedWeapon.Ammo));
          stringList1.Add(string.Format("Type : {0}", (object) this.DescribeAmmoType(model2.AmmoType)));
        }
      }
      return stringList1.ToArray();
    }
    ...
    {
      List<string> stringList = new List<string>();
      ItemFoodModel model = f.Model as ItemFoodModel;
      stringList.Add("> food");
      if (f.IsPerishable)
      {
    ...
    {
      List<string> stringList = new List<string>();
      ItemMedicineModel model = med.Model as ItemMedicineModel;
      stringList.Add("> medicine");
      int num1 = this.m_Player == null ? model.Healing : this.m_Rules.ActorMedicineEffect(this.m_Player, model.Healing);
      if (num1 == model.Healing)
        stringList.Add(string.Format("Healing : +{0}", (object) model.Healing));
      else
        stringList.Add(string.Format("Healing : +{0} (+{1})", (object) num1, (object) model.Healing));
      int num2 = this.m_Player == null ? model.StaminaBoost : this.m_Rules.ActorMedicineEffect(this.m_Player, model.StaminaBoost);
      if (num2 == model.StaminaBoost)
        stringList.Add(string.Format("Stamina : +{0}", (object) model.StaminaBoost));
      else
        stringList.Add(string.Format("Stamina : +{0} (+{1})", (object) num2, (object) model.StaminaBoost));
      int num3 = this.m_Player == null ? model.SleepBoost : this.m_Rules.ActorMedicineEffect(this.m_Player, model.SleepBoost);
      if (num3 == model.SleepBoost)
        stringList.Add(string.Format("Sleep   : +{0}", (object) model.SleepBoost));
      else
        stringList.Add(string.Format("Sleep   : +{0} (+{1})", (object) num3, (object) model.SleepBoost));
      int num4 = this.m_Player == null ? model.SanityCure : this.m_Rules.ActorMedicineEffect(this.m_Player, model.SanityCure);
      if (num4 == model.SanityCure)
        stringList.Add(string.Format("Sanity  : +{0}", (object) model.SanityCure));
      else
        stringList.Add(string.Format("Sanity  : +{0} (+{1})", (object) num4, (object) model.SanityCure));
      if (Rules.HasInfection(this.m_Session.GameMode))
      {
        int num5 = this.m_Player == null ? model.InfectionCure : this.m_Rules.ActorMedicineEffect(this.m_Player, model.InfectionCure);
        if (num5 == model.InfectionCure)
          stringList.Add(string.Format("Cure    : +{0}", (object) model.InfectionCure));
        else
          stringList.Add(string.Format("Cure    : +{0} (+{1})", (object) num5, (object) model.InfectionCure));
      }
      return stringList.ToArray();
    }
    ...
    {
      List<string> stringList = new List<string>();
      ItemBarricadeMaterialModel model = bm.Model as ItemBarricadeMaterialModel;
      stringList.Add("> barricade material");
      int num = this.m_Player == null ? model.BarricadingValue : this.m_Rules.ActorBarricadingPoints(this.m_Player, model.BarricadingValue);
      if (num == model.BarricadingValue)
        stringList.Add(string.Format("Barricading : +{0}", (object) model.BarricadingValue));
      else
        stringList.Add(string.Format("Barricading : +{0} (+{1})", (object) num, (object) model.BarricadingValue));
      return stringList.ToArray();
    }
    ...
    {
      List<string> stringList = new List<string>();
      ItemSprayPaintModel model = sp.Model as ItemSprayPaintModel;
      stringList.Add("> spray paint");
      if (sp.PaintQuantity < model.MaxPaintQuantity)
        stringList.Add(string.Format("Paint : {0}/{1}", (object) sp.PaintQuantity, (object) model.MaxPaintQuantity));
      else
    ...
    {
      List<string> stringList = new List<string>();
      ItemSprayScentModel model = sp.Model as ItemSprayScentModel;
      stringList.Add("> spray scent");
      if (sp.SprayQuantity < model.MaxSprayQuantity)
        stringList.Add(string.Format("Spray : {0}/{1}", (object) sp.SprayQuantity, (object) model.MaxSprayQuantity));
      else
    ...
    {
      List<string> stringList = new List<string>();
      ItemLightModel model = lt.Model as ItemLightModel;
      stringList.Add("> light");
      stringList.Add(this.DescribeBatteries(lt.Batteries, model.MaxBatteries));
    ...
    {
      List<string> stringList = new List<string>();
      ItemTrackerModel model = tr.Model as ItemTrackerModel;
      stringList.Add("> tracker");
      stringList.Add(this.DescribeBatteries(tr.Batteries, model.MaxBatteries));
      return stringList.ToArray();
    }
    ...
    {
      List<string> stringList = new List<string>();
      ItemTrapModel model = tr.Model as ItemTrapModel;
      stringList.Add("> trap");
      if (tr.IsActivated)
      ...
      if (model.IsNoisy)
        stringList.Add(string.Format("Makes {0} noise.", (object) model.NoiseName));
      if (model.UseToActivate)
        stringList.Add("Use to activate.");
      stringList.Add(string.Format("Damage  : {0}", (object) model.Damage));
      stringList.Add(string.Format("Trigger : {0}%", (object) model.TriggerChance));
      stringList.Add(string.Format("Break   : {0}%", (object) model.BreakChance));
      if (model.BlockChance > 0)
        stringList.Add(string.Format("Block   : {0}%", (object) model.BlockChance));
      if (model.BreakChanceWhenEscape > 0)
        stringList.Add(string.Format("{0}% to break on escape", (object) model.BreakChanceWhenEscape));
      return stringList.ToArray();
    }
    ...
    private string DescribeSkillShort(Skills.IDs id)
    {
      switch (id)
      {
        ...
        case Skills.IDs.NECROLOGY:
          return string.Format("+{0}/+{1} Dmg vs undeads, info on corpses", (object) Rules.SKILL_NECROLOGY_UNDEAD_BONUS, (object) Rules.SKILL_NECROLOGY_CORPSE_BONUS);
    ...
    private bool TryTriggerTrap(ItemTrap trap, Actor victim)
    {
      if (this.m_Rules.CheckTrapTriggers(trap, victim))
      {
        ...
        Point position = location.Position;
        Actor victim1 = victim;
        // ISSUE: variable of the null type
        __Null local = null;
        this.DoTriggerTrap(trap1, map, position, victim1, (MapObject) local);
      }
    ...
    private void DoTriggerTrap(ItemTrap trap, Map map, Point pos, Actor victim, MapObject mobj)
    {
      ...
      if (dmg > 0 && victim != null)
      {
        ...
        if (player)
        {
          ...
          Location location = victim.Location;
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location.Position), "Icons\\melee_damage"));
          location = victim.Location;
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayText(this.MapToScreen(location.Position).Add(10, 10), Color.White, dmg.ToString(), new Color?(Color.Black)));
          this.RedrawPlayScreen();
    ...
    public bool DoLeaveMap(Actor actor, Point exitPoint, bool askForConfirmation)
    {
      ...
      if (mapObjectAt != null && ((!mapObjectAt.IsJumpable ? 0 : (this.m_Rules.HasActorJumpAbility(actor) ? 1 : 0)) == 0 && !mapObjectAt.IsCouch))
      {
        if (isPlayer)
    ...
    public void DoSwitchPlace(Actor actor, Actor other)
    {
      ...
      Point position2 = location.Position;
      map.PlaceActorAt(actor1, position2);
      map.PlaceActorAt(other, position1);
    ...
    public bool DoPlayerBump(Actor player, Direction direction)
    {
      ...
      DoorWindow mapObjectAt = player.Location.Map.GetMapObjectAt(player.Location.Position + direction) as DoorWindow;
      if (mapObjectAt != null && mapObjectAt.IsBarricaded && !player.Model.Abilities.IsUndead)
      {
        if (!this.m_Rules.IsActorTired(player))
        {
          ...
          if (this.WaitYesOrNo())
          {
            this.DoBreak(player, (MapObject) mapObjectAt);
            return true;
          }
    ...
    private void OnMakeEnemyOfCop(Actor aggressor, Actor cop, bool wasAlreadyEnemy)
    {
      ...
      this.MakeEnemyOfTargetFactionInDistrict(aggressor, cop, (Action<Actor>) (a =>
      {
        ...
        string format = "Current location : {0}@{1},{2}";
        Location location = aggressor.Location;
        string name = location.Map.Name;
        location = aggressor.Location;
        Point position = location.Position;
        // ISSUE: variable of a boxed type
        __Boxed<int> x = (ValueType) position.X;
        position = aggressor.Location.Position;
        // ISSUE: variable of a boxed type
        __Boxed<int> y = (ValueType) position.Y;
        this.AddMessage(new djack.RogueSurvivor.Data.Message(string.Format(format, (object) name, (object) x, (object) y), turnCounter, Color.White));
        this.AddMessagePressEnter();
      }));
    }
    ...
    public void DoMeleeAttack(Actor attacker, Actor defender)
    {
      ...
      Location location1 = attacker.Location;
      Map map = location1.Map;
      location1 = attacker.Location;
      Point position1 = location1.Position;
      string noiseName = "Nearby fighting";
      this.OnLoudNoise(map, position1, noiseName);
      ...
      {
        Location location2 = attacker.Location;
        string eventText = "You hear fighting";
        location1 = attacker.Location;
        Point position2 = location1.Position;
        djack.RogueSurvivor.Data.Message msg = this.MakePlayerCentricMessage(eventText, position2);
        this.AddMessageIfAudibleForPlayer(location2, msg);
      }
      if (player2)
      {
        Color yellow = Color.Yellow;
        location1 = attacker.Location;
        Rectangle rect1 = new Rectangle(this.MapToScreen(location1.Position), new Size(32, 32));
        this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(yellow, rect1));
        Color red = Color.Red;
        location1 = defender.Location;
        Rectangle rect2 = new Rectangle(this.MapToScreen(location1.Position), new Size(32, 32));
        this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(red, rect2));
        location1 = attacker.Location;
        this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location1.Position), "Icons\\melee_attack"));
      }
      int num3 = num2;
      if (num1 > num3)
      {
        int num4 = this.m_Rules.RollDamage(defender.IsSleeping ? attack.DamageValue * 2 : attack.DamageValue) - defence.Protection_Hit;
        if (num4 > 0)
        {
          this.InflictDamage(defender, num4);
          if (attacker.Model.Abilities.CanZombifyKilled && !defender.Model.Abilities.IsUndead)
          {
            this.RegenActorHitPoints(attacker, this.Rules.ActorBiteHpRegen(attacker, num4));
            attacker.FoodPoints = Math.Min(attacker.FoodPoints + this.m_Rules.ActorBiteNutritionValue(attacker, num4), this.m_Rules.ActorMaxRot(attacker));
            if (player2)
              this.AddMessage(this.MakeMessage(attacker, this.Conjugate(attacker, this.VERB_FEAST_ON), defender, " flesh !"));
            this.InfectActor(defender, Rules.InfectionForDamage(attacker, num4));
          }
          if (defender.HitPoints <= 0)
          {
            if (player2 | player1)
            {
              ...
              location1 = defender.Location;
              this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location1.Position), "Icons\\killed"));
              this.RedrawPlayScreen();
              this.AnimDelay(1000);
            }
            ...
            if (Rules.HasImmediateZombification(this.m_Session.GameMode) || defender == this.m_Player)
            {
              if (attacker.Model.Abilities.CanZombifyKilled && !defender.Model.Abilities.IsUndead && this.m_Rules.RollChance(RogueGame.s_Options.ZombificationChance))
              {
                ...
                {
                  location1 = defender.Location;
                  location1.Map.TryRemoveCorpseOf(defender);
                }
          ...
          {
            this.AddMessage(this.MakeMessage(attacker, this.Conjugate(attacker, attack.Verb), defender, string.Format(" for {0} damage.", (object) num4)));
            location1 = defender.Location;
            this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location1.Position), "Icons\\melee_damage"));
            location1 = defender.Location;
            this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayText(this.MapToScreen(location1.Position).Add(10, 10), Color.White, num4.ToString(), new Color?(Color.Black)));
            this.RedrawPlayScreen();
        ...
        else if (player2 | player1)
        {
          ...
          location1 = defender.Location;
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location1.Position), "Icons\\melee_miss"));
          this.RedrawPlayScreen();
          this.AnimDelay(flag ? 500 : 250);
        }
      }
      ...
      ItemMeleeWeapon equippedWeapon = attacker.GetEquippedWeapon() as ItemMeleeWeapon;
      if (equippedWeapon != null && !(equippedWeapon.Model as ItemMeleeWeaponModel).IsUnbreakable && this.m_Rules.RollChance(equippedWeapon.IsFragile ? 3 : 1))
      {
        this.OnUnequipItem(attacker, (Item) equippedWeapon);
        if (equippedWeapon.Quantity > 1)
          --equippedWeapon.Quantity;
        else
          attacker.Inventory.RemoveAllQuantity((Item) equippedWeapon);
        if (player2)
        {
          this.AddMessage(this.MakeMessage(attacker, string.Format(": {0} breaks and is now useless!", (object) equippedWeapon.TheName)));
          this.RedrawPlayScreen();
          this.AnimDelay(flag ? 500 : 250);
        }
      }
    ...
    public void DoSingleRangedAttack(Actor attacker, Actor defender, List<Point> LoF, FireMode mode)
    {
      ...
      if (mode != FireMode.DEFAULT)
      {
        ...
        ItemRangedWeapon equippedWeapon = attacker.GetEquippedWeapon() as ItemRangedWeapon;
        if (defender.IsDead)
        {
          --equippedWeapon.Ammo;
    ...
    private void DoSingleRangedAttack(Actor attacker, Actor defender, List<Point> LoF, float accuracyFactor)
    {
      ...
      location1 = defender.Location;
      Point position2 = location1.Position;
      int distance = rules.GridDistance(position1, position2);
      ...
      else
      {
        ...
        if (player2)
        {
          ...
          location2 = attacker.Location;
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location2.Position), "Icons\\ranged_attack"));
        }
        int num3 = num2;
        if (num1 > num3)
        {
          ...
          if (dmg > 0)
          {
            ...
            if (defender.HitPoints <= 0)
            {
              ...
              {
                this.AddMessage(this.MakeMessage(attacker, this.Conjugate(attacker, defender.Model.Abilities.IsUndead ? this.VERB_DESTROY : (this.m_Rules.IsMurder(attacker, defender) ? this.VERB_MURDER : this.VERB_KILL)), defender, " !"));
                location2 = defender.Location;
                this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location2.Position), "Icons\\killed"));
                this.RedrawPlayScreen();
                this.AnimDelay(1000);
              }
            ...
            else if (player1)
            {
              ...
              location2 = defender.Location;
              this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location2.Position), "Icons\\ranged_damage"));
              location2 = defender.Location;
              this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayText(this.MapToScreen(location2.Position).Add(10, 10), Color.White, dmg.ToString(), new Color?(Color.Black)));
              this.RedrawPlayScreen();
              this.AnimDelay(flag ? 500 : 250);
            }
          }
          else if (player1)
          {
            this.AddMessage(this.MakeMessage(attacker, this.Conjugate(attacker, attack.Verb), defender, " for no effect."));
            location2 = defender.Location;
            this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location2.Position), "Icons\\ranged_miss"));
            this.RedrawPlayScreen();
            this.AnimDelay(flag ? 500 : 250);
          }
        }
    ...
    private bool DoCheckFireThrough(Actor attacker, List<Point> LoF)
    {
      ...
      {
        Location location = attacker.Location;
        MapObject mapObjectAt = location.Map.GetMapObjectAt(point);
        if (mapObjectAt != null && mapObjectAt.BreaksWhenFiredThrough && (mapObjectAt.BreakState != MapObject.Break.BROKEN && !mapObjectAt.IsWalkable))
        {
          ...
          if (player1 | player2)
          {
            if (player1)
            {
              ...
              Rectangle rect = new Rectangle(this.MapToScreen(location.Position), new Size(32, 32));
              this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(yellow, rect));
              location = attacker.Location;
              this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location.Position), "Icons\\ranged_attack"));
            }
            if (player2)
    ...
    {
      ItemGrenade equippedWeapon = actor.GetEquippedWeapon() as ItemGrenade;
      if (equippedWeapon == null)
        throw new InvalidOperationException("throwing grenade but no grenade equiped ");
      this.SpendActorActionPoints(actor, 100);
      actor.Inventory.Consume((Item) equippedWeapon);
      actor.Location.Map.DropItemAt((Item) new ItemGrenadePrimed(this.m_GameItems[equippedWeapon.PrimedModelID]), targetPos);
      if ((this.IsVisibleToPlayer(actor) ? 1 : (this.IsVisibleToPlayer(actor.Location.Map, targetPos) ? 1 : 0)) == 0)
        return;
      ...
      this.AddMessage(this.MakeMessage(actor, string.Format("{0} a {1}!", (object) this.Conjugate(actor, this.VERB_THROW), (object) equippedWeapon.Model.SingleName)));
      this.RedrawPlayScreen();
      this.AnimDelay(1000);
      this.ClearOverlays();
      this.RedrawPlayScreen();
    ...
    {
      ItemGrenadePrimed equippedWeapon = actor.GetEquippedWeapon() as ItemGrenadePrimed;
      if (equippedWeapon == null)
        throw new InvalidOperationException("throwing primed grenade but no primed grenade equiped ");
      this.SpendActorActionPoints(actor, 100);
      actor.Inventory.RemoveAllQuantity((Item) equippedWeapon);
      actor.Location.Map.DropItemAt((Item) equippedWeapon, targetPos);
      if ((this.IsVisibleToPlayer(actor) ? 1 : (this.IsVisibleToPlayer(actor.Location.Map, targetPos) ? 1 : 0)) == 0)
        return;
      this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(Color.Yellow, new Rectangle(this.MapToScreen(actor.Location.Position), new Size(32, 32))));
      this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayRect(Color.Red, new Rectangle(this.MapToScreen(targetPos), new Size(32, 32))));
      this.AddMessage(this.MakeMessage(actor, string.Format("{0} back a {1}!", (object) this.Conjugate(actor, this.VERB_THROW), (object) equippedWeapon.Model.SingleName)));
      this.RedrawPlayScreen();
      this.AnimDelay(1000);
      this.ClearOverlays();
      this.RedrawPlayScreen();
    ...
    private int ApplyExplosionDamage(Location location, int distanceFromBlast, BlastAttack blast)
    {
      ...
      if (actorAt != null)
      {
        ...
        int num2 = num1;
        Defence currentDefence = actorAt.CurrentDefence;
        int protectionHit = currentDefence.Protection_Hit;
        currentDefence = actorAt.CurrentDefence;
        int protectionShot = currentDefence.Protection_Shot;
        int num3 = (protectionHit + protectionShot) / 2;
        int dmg = num2 - num3;
        if (dmg > 0)
        {
    ...
    public void DoChat(Actor speaker, Actor target)
    {
      ...
      if ((this.IsVisibleToPlayer(speaker) ? 1 : (this.IsVisibleToPlayer(target) ? 1 : 0)) != 0)
    ...
    public void DoSay(Actor speaker, Actor target, string text, RogueGame.Sayflags flags)
    {
      ...
      if (!this.IsVisibleToPlayer(speaker) && (!this.IsVisibleToPlayer(target) || this.m_Player.IsSleeping && target == this.m_Player))
        return;
      int num = target.IsPlayer ? 1 : 0;
      bool flag = (uint) (flags & RogueGame.Sayflags.IS_IMPORTANT) > 0U;
      if ((num & (flag ? 1 : 0)) != 0)
        this.ClearMessages();
    ...
    {
      this.SpendActorActionPoints(speaker, 100);
      Location location = speaker.Location;
      Map map = location.Map;
      location = speaker.Location;
      Point position = location.Position;
      string noiseName = "A SHOUT";
      this.OnLoudNoise(map, position, noiseName);
    ...
    public void DoGiveItemTo(Actor actor, Actor target, Item gift)
    {
      ...
      {
        BaseAI controller = target.Controller as BaseAI;
        bool flag = controller != null && controller.IsInterestingItem(this, gift);
        if (flag)
    ...
    private void OnEquipItem(Actor actor, Item it)
    {
      if (it.Model is ItemWeaponModel)
      {
        ...
        {
          ItemMeleeWeaponModel model = it.Model as ItemMeleeWeaponModel;
          actor.CurrentMeleeAttack = new Attack(model.Attack.Kind, model.Attack.Verb, model.Attack.HitValue + actor.Sheet.UnarmedAttack.HitValue, model.Attack.DamageValue + actor.Sheet.UnarmedAttack.DamageValue, model.Attack.StaminaPenalty);
        }
        else
        {
          if (!(it.Model is ItemRangedWeaponModel))
            return;
          ItemRangedWeaponModel model = it.Model as ItemRangedWeaponModel;
          actor.CurrentRangedAttack = new Attack(model.Attack.Kind, model.Attack.Verb, model.Attack.HitValue, model.Attack.DamageValue, model.Attack.StaminaPenalty, model.Attack.Range);
        }
      }
      else if (it.Model is ItemBodyArmorModel)
      {
        ItemBodyArmorModel model = it.Model as ItemBodyArmorModel;
        actor.CurrentDefence += model.ToDefence();
      }
    ...
    public void DoEatFoodFromGround(Actor actor, Item it)
    {
      ...
      location = actor.Location;
      Point position = location.Position;
      map.GetItemsAt(position).Consume((Item) food);
      bool player = this.IsVisibleToPlayer(actor);
      if (player)
    ...
    private void DoUseFoodItem(Actor actor, ItemFood food)
    {
      ...
      else
      {
        ...
        {
          ItemTrap itemTrap1 = new ItemTrap(this.GameItems.EMPTY_CAN)
          {
            IsActivated = true
          };
          Map map = actor.Location.Map;
          ItemTrap itemTrap2 = itemTrap1;
          location = actor.Location;
          Point position = location.Position;
          map.DropItemAt((Item) itemTrap2, position);
        }
        bool player = this.IsVisibleToPlayer(actor);
        if (player)
          this.AddMessage(this.MakeMessage(actor, this.Conjugate(actor, this.VERB_EAT), (Item) food));
        ...
        if (!rules.IsFoodSpoiled(food1, turnCounter) || !this.m_Rules.RollChance(25))
          return;
        this.DoVomit(actor);
        if (!player)
          return;
    ...
    private void DoVomit(Actor actor)
    {
      ...
      int y = position.Y;
      map.GetTileAt(x, y).AddDecoration("Tiles\\Decoration\\vomit");
    }
    ...
    private void DoUseMedicineItem(Actor actor, ItemMedicine med)
    {
      if (actor == this.m_Player)
      {
        ...
        int num5 = 0;
        int num6 = num1 <= num5 ? 1 : (med.Healing <= 0 ? 1 : 0);
        bool flag1 = num2 <= 0 || med.StaminaBoost <= 0;
        bool flag2 = num3 <= 0 || med.SleepBoost <= 0;
        bool flag3 = infection <= 0 || med.InfectionCure <= 0;
        bool flag4 = num4 <= 0 || med.SanityCure <= 0;
        int num7 = flag1 ? 1 : 0;
        if ((num6 & num7 & (flag2 ? 1 : 0) & (flag3 ? 1 : 0) & (flag4 ? 1 : 0)) != 0)
        {
          this.AddMessage(this.MakeErrorMessage("I shouldn't waste medicine!"));
          return;
        }
      }
      this.SpendActorActionPoints(actor, 100);
    ...
    private void DoUseAmmoItem(Actor actor, ItemAmmo ammoItem)
    {
      ...
      int num = Math.Min((equippedWeapon.Model as ItemRangedWeaponModel).MaxAmmo - equippedWeapon.Ammo, ammoItem.Quantity);
      equippedWeapon.Ammo += num;
      ammoItem.Quantity -= num;
      if (ammoItem.Quantity <= 0)
        actor.Inventory.RemoveAllQuantity((Item) ammoItem);
      if (!this.IsVisibleToPlayer(actor))
        return;
      this.AddMessage(this.MakeMessage(actor, this.Conjugate(actor, this.VERB_RELOAD), (Item) equippedWeapon));
    }
    ...
    private void DoUseSprayScentItem(Actor actor, ItemSprayScent spray)
    {
      ...
      int odor = (int) model.Odor;
      int strength = model.Strength;
      location = actor.Location;
      Point position = location.Position;
      map.ModifyScentAt((Odor) odor, strength, position);
      if (!this.IsVisibleToPlayer(actor))
        return;
    ...
    {
      int num = this.IsVisibleToPlayer(actor) ? 1 : 0;
      this.SpendActorActionPoints(actor, 100);
    ...
    {
      ItemBarricadeMaterial firstByType = actor.Inventory.GetFirstByType(typeof (ItemBarricadeMaterial)) as ItemBarricadeMaterial;
      ItemBarricadeMaterialModel model = firstByType.Model as ItemBarricadeMaterialModel;
      actor.Inventory.Consume((Item) firstByType);
      door.BarricadePoints = Math.Min(door.BarricadePoints + this.m_Rules.ActorBarricadingPoints(actor, model.BarricadingValue), 80);
      if ((this.IsVisibleToPlayer(actor) ? 1 : (this.IsVisibleToPlayer((MapObject) door) ? 1 : 0)) != 0)
    ...
    public void DoRepairFortification(Actor actor, Fortification fort)
    {
      ...
      actor.Inventory.Consume((Item) firstByType);
      fort.HitPoints = Math.Min(fort.MaxHitPoints, fort.HitPoints + this.m_Rules.ActorBarricadingPoints(actor, (firstByType.Model as ItemBarricadeMaterialModel).BarricadingValue));
    ...
    private void DoDestroyObject(MapObject mapObj)
    {
      ...
      if (mapObj.GivesWood)
      {
        ...
        while (val2 > 0)
        {
          ...
          Item obj = (Item) barricadeMaterial;
          if (obj.Quantity < 1)
            obj.Quantity = 1;
        ...
        {
          ItemMeleeWeapon itemMeleeWeapon1 = !this.m_Rules.RollChance(50) ? new ItemMeleeWeapon((ItemModel) this.m_GameItems.IMPROVISED_SPEAR) : new ItemMeleeWeapon((ItemModel) this.m_GameItems.IMPROVISED_CLUB);
          location = mapObj.Location;
          Map map = location.Map;
          ItemMeleeWeapon itemMeleeWeapon2 = itemMeleeWeapon1;
          location = mapObj.Location;
          Point position = location.Position;
          map.DropItemAt((Item) itemMeleeWeapon2, position);
        }
      }
      if (flag)
      {
      ...
      location = mapObj.Location;
      Point position1 = location.Position;
      string noiseName = "A loud *CRASH*";
      this.OnLoudNoise(map1, position1, noiseName);
    }
    ...
    public void DoBreak(Actor actor, MapObject mapObj)
    {
      ...
      if (doorWindow != null && doorWindow.IsBarricaded)
      {
        ...
        Location location1 = doorWindow.Location;
        Map map = location1.Map;
        location1 = doorWindow.Location;
        Point position1 = location1.Position;
        string noiseName = "A loud *BASH*";
        this.OnLoudNoise(map, position1, noiseName);
        ...
        else
        {
          if (!this.m_Rules.RollChance(25))
            return;
          Location location2 = doorWindow.Location;
          string eventText = "You hear someone bashing barricades";
          location1 = doorWindow.Location;
          Point position2 = location1.Position;
          djack.RogueSurvivor.Data.Message msg = this.MakePlayerCentricMessage(eventText, position2);
          this.AddMessageIfAudibleForPlayer(location2, msg);
    ...
    public void DoPush(Actor actor, MapObject mapObj, Point toPos)
    {
      ...
      if (actor.CountFollowers > 0)
      {
        ...
        Map map = location1.Map;
        location1 = mapObj.Location;
        Point position = location1.Position;
        Location location2 = new Location(map, position);
        List<Actor> actorList = (List<Actor>) null;
      ...
      Map map1 = mapObj.Location.Map;
      Point position1 = mapObj.Location.Position;
      map1.RemoveMapObjectAt(mapObj.Location.Position.X, mapObj.Location.Position.Y);
      map1.PlaceMapObjectAt(mapObj, toPos);
      if (!this.m_Rules.IsAdjacent(toPos, actor.Location.Position) && this.m_Rules.IsWalkableFor(actor, map1, position1.X, position1.Y))
      {
        map1.RemoveActor(actor);
        map1.PlaceActorAt(actor, position1);
      }
      if (flag)
      {
    ...
    public void DoShove(Actor actor, Actor target, Point toPos)
    {
      ...
      else
      {
        ...
        if ((this.IsVisibleToPlayer(actor) || this.IsVisibleToPlayer(target) ? 1 : (this.IsVisibleToPlayer(map, toPos) ? 1 : 0)) != 0)
        {
    ...
    private void DoGiveOrderTo(Actor master, Actor slave, ActorOrder order)
    {
      ...
      {
        AIController controller = slave.Controller as AIController;
        if (controller == null)
          return;
    ...
    public void KillActor(Actor killer, Actor deadGuy, string reason)
    {
      ...
      if (killer != null && !killer.Model.Abilities.IsUndead && (killer.Model.Abilities.HasSanity && deadGuy.Model.Abilities.IsUndead))
        this.RegenActorSanity(killer, this.m_Rules.ActorSanRegenValue(killer, 90));
      ...
      if (deadGuy.Inventory != null && !deadGuy.Inventory.IsEmpty)
      {
        ...
        for (int index = 0; index < objArray.Length; ++index)
        {
          ...
          int chance = it is ItemAmmo || it is ItemFood ? 100 : 100;
      ...
      {
        Map map = deadGuy.Location.Map;
        location = deadGuy.Location;
        Point position = location.Position;
        this.SplatterBlood(map, position);
      }
      if (RogueGame.s_Options.ShowCorpses)
      {
        if (deadGuy.Model.Abilities.IsUndead)
        {
          location = deadGuy.Location;
          ...
          location = deadGuy.Location;
          Point position = location.Position;
          this.UndeadRemains(map, position);
        }
        else
          this.DropCorpse(deadGuy);
      }
      else if (Rules.HasCorpses(this.m_Session.GameMode) && !deadGuy.Model.Abilities.IsUndead)
        this.DropCorpse(deadGuy);
      if (killer != null)
        ++killer.KillsCount;
      ...
      if (flag1)
      {
        ...
        foreach (Actor actor in map.Actors)
        {
          if (actor.Model.Abilities.IsLawEnforcer && !actor.IsDead && (!actor.IsSleeping && !actor.IsPlayer) && (actor != killer && actor != deadGuy && (actor.Leader != killer && killer.Leader != actor)))
          {
            Rules rules = this.m_Rules;
            location = actor.Location;
            Point position2 = location.Position;
            Point pB = position1;
            if (rules.GridDistance(position2, pB) <= this.m_Rules.ActorFOV(actor, map.LocalTime, this.m_Session.World.Weather) && LOS.CanTraceViewLine(actor.Location, position1))
            {
    ...
    private void HandlePostMortem()
    {
      ...
      int num1 = this.m_Player.Model.DollBody.IsMale ? 1 : 0;
      string str1 = num1 != 0 ? "He" : "She";
      this.HisOrHer(this.m_Player);
      string str2 = num1 != 0 ? "him" : "her";
      string name = this.m_Player.TheName.Replace("(YOU) ", "");
      string str3 = this.TimeSpanToString(this.m_Session.Scoring.RealLifePlayingTime);
      ...
      textFile.Append(string.Format("ROGUE SURVIVOR {0}", (object) SetupConfig.GAME_VERSION));
      ...
      textFile.Append(string.Format("{0}'s spirit guided {1} for {2}.", (object) name, (object) str2, (object) str3));
      ...
      else
      {
        ...
        {
          string str4 = kill.Amount > 1 ? Models.Actors[kill.ActorModelID].PluralName : Models.Actors[kill.ActorModelID].Name;
          textFile.Append(string.Format("{0,4} {1}.", (object) kill.Amount, (object) str4));
        }
      }
      ...
      textFile.Append(string.Format("While {0} has died, others are still surviving", (object) name));
      ...
      else
      {
        ...
        {
          string str4 = this.DescribeItemShort(it);
          if (it.IsEquipped)
            textFile.Append(string.Format("- {0} (equipped).", (object) str4));
          else
            textFile.Append(string.Format("- {0}.", (object) str4));
        }
      }
      textFile.Append(" ");
      ...
      {
        textFile.Append(string.Format("{0} was a lone wolf. Or everyone else was dead.", (object) str1));
      }
      else
      {
      ...
      {
        foreach (Scoring.GameEventData gameEventData in this.m_Session.Scoring.Events)
          textFile.Append(string.Format("- {0,13} : {1}", (object) new WorldTime()
          {
            TurnCounter = gameEventData.Turn
          }.ToString(), (object) gameEventData.Text));
      }
      textFile.Append(" ");
      ...
      if (RogueGame.s_Options.IsSanityEnabled)
        textFile.Append(string.Format("- {0} : {1}.", (object) GameOptions.Name(GameOptions.IDs.GAME_SANITY), RogueGame.s_Options.IsSanityEnabled ? (object) "on" : (object) "off"));
      ...
      textFile.Append(string.Format("May {0} rest in peace, and not rise again.", (object) this.HisOrHer(this.m_Player)));
      int num3;
      int num4 = num3 = 0;
      this.m_UI.UI_Clear(Color.Black);
      ...
      int gy1 = num3 + 14;
      this.m_UI.UI_Repaint();
      string str5 = RogueGame.GraveFilePath(this.GetUserNewGraveyardName());
      int num5;
      if (!textFile.Save(str5))
      {
      ...
      else
      {
        ...
        int gy2 = gy1 + 14;
        this.m_UI.UI_DrawString(Color.White, str5, 0, gy2, new Color?());
        num5 = gy2 + 14;
      }
      this.DrawFootnote(Color.White, "press ENTER");
      this.m_UI.UI_Repaint();
      ...
      do
      {
        ...
        this.m_UI.UI_DrawStringBold(Color.White, "---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+", 0, gy2, new Color?());
        int gy3 = gy2 + 14;
        for (; num6 < 50 && index < textFile.FormatedLines.Count; ++num6)
        {
    ...
    private void HandlePlayerDecideUpgrade(Actor upgradeActor)
    {
      ...
      string str = upgradeActor == this.m_Player ? "You are" : upgradeActor.Name + " is";
      bool flag = true;
      do
      {
        this.ClearMessages();
        ...
        int count = upgrade.Count;
        if (count <= 1 && !GameOptions.m_SanityGlobal)
          this.AddMessage(this.MakeErrorMessage(str + " fully skilled and can't learn anything new."));
        else if (count == 0)
        {
          this.AddMessage(this.MakeErrorMessage(str + " fully skilled and can't learn anything new."));
        }
    ...
    private void HandlePlayerFollowersUpgrade()
    {
      if (this.m_Player.CountFollowers == 0)
        return;
      this.ClearMessages();
      this.AddMessage(new djack.RogueSurvivor.Data.Message("Your followers learned new skills!", this.m_Session.WorldTime.TurnCounter, Color.Green));
      this.AddMessagePressEnter();
      foreach (Actor follower in this.m_Player.Followers)
      ...
      else
      {
        switch (skID)
        {
          ...
          case Skills.IDs.STRONG:
            return 2;
          case Skills.IDs.STRONG_PSYCHE:
            return GameOptions.m_SanityGlobal && actor.Model.Abilities.HasSanity ? 3 : 0;
          case Skills.IDs.TOUGH:
            return 3;
          case Skills.IDs.UNSUSPICIOUS:
    ...
    private Skills.IDs? RollRandomSkillToUpgrade(Actor actor, int maxTries)
    {
      ...
      else
      {
        do
        {
          ++num;
          id = isUndead ? (int) Skills.RollUndead(this.Rules.DiceRoller) : (int) Skills.RollLiving(this.Rules.DiceRoller);
          if (Skills.Name(id) == "Strong Psyche")
            id = 0;
        }
        while (actor.Sheet.SkillTable.GetSkillLevel(id) >= Skills.MaxSkillLevel(id) && num < maxTries);
      }
    ...
    {
      BaseTownGenerator townGenerator = this.m_TownGenerator;
      Actor zombifier1 = zombifier;
      Actor deadVictim1 = deadVictim;
      Location location;
      int turn;
      if (!isStartingGame)
      {
        location = deadVictim.Location;
        turn = location.Map.LocalTime.TurnCounter;
      }
      else
        turn = 0;
      Actor actor1 = townGenerator.MakeZombified(zombifier1, deadVictim1, turn);
      if (!isStartingGame)
      {
        location = deadVictim.Location;
        Map map = location.Map;
        ...
        location = deadVictim.Location;
        Point position = location.Position;
        map.PlaceActorAt(actor2, position);
      }
      actor1.ActionPoints = 0;
      if (deadVictim == this.m_Player || deadVictim.IsPlayer)
        this.m_Session.Scoring.SetZombifiedPlayer(actor1);
      SkillTable skillTable = deadVictim.Sheet.SkillTable;
      if (skillTable != null && skillTable.CountSkills > 0)
      {
        if (actor1.Sheet.SkillTable == null)
          actor1.Sheet.SkillTable = new SkillTable();
        ...
        for (int index = 0; index < num; ++index)
        {
          ...
          if (nullable.HasValue)
            this.SkillUpgrade(actor1, nullable.Value);
        }
        this.m_TownGenerator.RecomputeActorStartingStats(actor1);
      }
      if (!isStartingGame)
        this.SeeingCauseInsanity(actor1, actor1.Location, 60, string.Format("{0} turning into a zombie", (object) deadVictim.Name));
      return actor1;
    }
    ...
    public void RedrawPlayScreen()
    {
      ...
      foreach (RogueGame.Overlay overlay in this.m_Overlays)
        overlay.Draw(this.m_UI);
    ...
    private string LocationText(Map map, Actor actor)
    {
      ...
      string format = "({0},{1}) ";
      // ISSUE: variable of a boxed type
      __Boxed<int> x1 = (ValueType) actor.Location.Position.X;
      Location location = actor.Location;
      // ISSUE: variable of a boxed type
      __Boxed<int> y1 = (ValueType) location.Position.Y;
      StringBuilder stringBuilder = new StringBuilder(string.Format(format, (object) x1, (object) y1));
      Map map1 = map;
      location = actor.Location;
      int x2 = location.Position.X;
      int y2 = actor.Location.Position.Y;
      List<Zone> zonesAt = map1.GetZonesAt(x2, y2);
      if (zonesAt == null || zonesAt.Count == 0)
    ...
    public void DrawMap(Map map, Color tint)
    {
      ...
      for (int x = num1; x < num2; ++x)
      {
        ...
        for (int y = num3; y < num4; ++y)
        {
          ...
          Location location;
          if (RogueGame.s_Options.ShowPlayerTargets && !this.m_Player.IsSleeping)
          {
            location = this.m_Player.Location;
          ...
          if (!this.m_Player.IsSleeping && map.IsInBounds(x, y))
          {
            Rules rules = this.m_Rules;
            location = this.m_Player.Location;
            Point position = location.Position;
            Point pB = point;
            if (rules.GridDistance(position, pB) <= 1)
            {
              if (isUndead)
              {
                if (flag1)
    ...
    public void DrawActorSprite(Actor actor, Point screen, Color tint)
    {
      ...
      if (this.m_Player != null)
      {
        int num = this.m_Player.IsSelfDefenceFrom(actor) ? 1 : 0;
        bool flag1 = this.m_Player.IsAggressorOf(actor);
        bool flag2 = this.m_Player.AreIndirectEnemies(actor);
        if (num != 0)
    ...
    public void DrawActorTargets(Actor actor)
    {
      ...
      {
        location = actor.TargetActor.Location;
        this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location.Position), "Icons\\is_target"));
      }
      location = actor.Location;
      foreach (Actor actor1 in location.Map.Actors)
      {
        ...
        {
          location = actor.Location;
          this.AddOverlay((RogueGame.Overlay) new RogueGame.OverlayImage(this.MapToScreen(location.Position), "Icons\\is_targetted"));
          break;
        }
      }
    }
    ...
    public void DrawPlayerActorTargets(Actor player)
    {
      ...
      Location location = player.Location;
      foreach (Actor actor in location.Map.Actors)
      {
        ...
        {
          location = player.Location;
          Point screen = this.MapToScreen(location.Position);
    ...
    public void DrawMiniMap(Map map)
    {
      ...
      {
        ItemTracker equippedItem1 = this.m_Player.GetEquippedItem(DollPart.LEFT_HAND) as ItemTracker;
        if (equippedItem1 != null && equippedItem1.Batteries > 0)
        {
          if (this.m_Player.CountFollowers > 0 && equippedItem1.CanTrackFollowersOrLeader)
          {
            foreach (Actor follower in this.m_Player.Followers)
            {
              Location location = follower.Location;
              ...
              if (map1 == map2)
              {
                ItemTracker equippedItem2 = follower.GetEquippedItem(DollPart.LEFT_HAND) as ItemTracker;
                if (equippedItem2 != null && equippedItem2.CanTrackFollowersOrLeader)
                {
                  Point point;
                  ...
                  location = follower.Location;
                  if (this.IsInViewRect(location.Position) && !this.IsVisibleToPlayer(follower))
                  {
                    location = follower.Location;
                    Point screen = this.MapToScreen(location.Position);
          ...
          if (equippedItem1.CanTrackUndeads)
          {
            foreach (Actor actor in map.Actors)
            {
              if (actor != this.m_Player && actor.Model.Abilities.IsUndead)
              {
                Location location = actor.Location;
                Map map1 = location.Map;
                location = this.m_Player.Location;
                ...
                if (map1 == map2)
                {
                  ...
                  location = this.m_Player.Location;
                  Point position2 = location.Position;
                  if (rules.GridDistance(position1, position2) <= 6)
                  {
                    Point point;
                    ref Point local = ref point;
                    int num1 = 750;
                    ...
                    int num2 = position3.X * 2;
                    int x = num1 + num2;
                    int num3 = 475;
                    location = actor.Location;
                    position3 = location.Position;
                    int num4 = position3.Y * 2;
                    int y = num3 + num4;
                    local = new Point(x, y);
                    this.m_UI.UI_DrawImage("mini_undead_position", point.X - 1, point.Y - 1);
                    location = actor.Location;
                    if (this.IsInViewRect(location.Position) && !this.IsVisibleToPlayer(actor))
                    {
                      location = actor.Location;
                      Point screen = this.MapToScreen(location.Position);
          ...
          if (equippedItem1.CanTrackBlackOps)
          {
            foreach (Actor actor in map.Actors)
            {
              if (actor != this.m_Player && actor.Faction == this.GameFactions.TheBlackOps)
              {
                Location location = actor.Location;
                Map map1 = location.Map;
                location = this.m_Player.Location;
          ...
          if (equippedItem1.CanTrackPolice)
          {
            foreach (Actor actor in map.Actors)
            {
              if (actor != this.m_Player && actor.Faction == this.GameFactions.ThePolice)
              {
                Location location = actor.Location;
                Map map1 = location.Map;
                location = this.m_Player.Location;
      ...
      int num5 = 750;
      Location location1 = this.m_Player.Location;
      Point position4 = location1.Position;
      int num6 = position4.X * 2;
      int x1 = num5 + num6;
      int num7 = 475;
      location1 = this.m_Player.Location;
      position4 = location1.Position;
      int num8 = position4.Y * 2;
      int y1 = num7 + num8;
    ...
    {
      this.m_UI.UI_DrawStringBold(Color.Yellow, string.Format("{0}, {1}", (object) actor.Name, (object) actor.Faction.MemberName), gx, gy, new Color?());
      gy += 14;
      ...
      if (equippedWeapon != null)
      {
        int ammo = equippedWeapon.Ammo;
        int maxAmmo = (equippedWeapon.Model as ItemRangedWeaponModel).MaxAmmo;
    ...
    private void DeleteSavedGame(string saveName)
    {
      if (!Session.Delete(saveName))
        return;
      this.AddMessage(new djack.RogueSurvivor.Data.Message("PERMADEATH ENABLED : SAVE GAME DELETED!", this.m_Session.WorldTime.TurnCounter, Color.Red));
    }
    ...
    {
      this.m_UI.UI_DrawStringBold(Color.Red, "ROGUE SURVIVOR - " + SetupConfig.GAME_VERSION, 0, 0, new Color?(Color.DarkRed));
    }
    ...
    private bool CheckDirectory(string path, string description, ref int gy)
    {
      ...
      gy += 14;
      this.m_UI.UI_Repaint();
      int num = this.CreateDirectory(path) ? 1 : 0;
    ...
    {
      return "Resources\\Manual\\" + "RS Manual.txt";
    }
    ...
    private UniqueActor SpawnUniqueSewersThing(World world)
    {
      ...
      if (zoneByPartialName != null)
        this.m_TownGenerator.MapObjectPlaceInGoodPosition(map, zoneByPartialName.Bounds, (Func<Point, bool>) (pt =>
        {
          ...
          return false;
        }), roller, (Func<Point, MapObject>) (pt => this.m_TownGenerator.MakeObjBoard("MapObjects\\announcement_board", new string[5]
        {
          "TO SEWER WORKERS :",
          "- It lives here.",
          "- Watch your back.",
    ...
    private UniqueMap CreateUniqueMap_CHARUndegroundFacility(World world)
    {
      ...
      Map map = mapCharUnderground;
      string format = "CHAR Underground Facility @{0}-{1}";
      Point worldPosition = district.WorldPosition;
      // ISSUE: variable of a boxed type
      __Boxed<int> x = (ValueType) worldPosition.X;
      worldPosition = district.WorldPosition;
      // ISSUE: variable of a boxed type
      __Boxed<int> y = (ValueType) worldPosition.Y;
      string str = string.Format(format, (object) x, (object) y);
      map.Name = str;
      district.AddUniqueMap(mapCharUnderground);
      return new UniqueMap() { TheMap = mapCharUnderground };
    }
    ...
    private Map GenerateDistrictEntryMap(World world, District district, Point policeStationDistrictPos, Point hospitalDistrictPos)
    {
      ...
      BaseTownGenerator.Parameters defaultParams = BaseTownGenerator.DEFAULT_PARAMS;
      defaultParams.MapWidth = defaultParams.MapHeight = RogueGame.s_Options.DistrictSize;
      defaultParams.District = district;
      int num = 8;
      string str;
      switch (district.Kind)
      {
        ...
        case DistrictKind.RESIDENTIAL:
          ...
          defaultParams.CHARBuildingChance /= num;
          defaultParams.ParkBuildingChance /= num;
          defaultParams.ShopBuildingChance /= num;
          break;
        case DistrictKind.SHOPPING:
      ...
      defaultParams.GeneratePoliceStation = district.WorldPosition == policeStationDistrictPos;
      defaultParams.GenerateHospital = district.WorldPosition == hospitalDistrictPos;
      BaseTownGenerator.Parameters parameters = this.m_TownGenerator.Params;
      this.m_TownGenerator.Params = defaultParams;
    ...
    private Map GenerateDistrictSewersMap(District district)
    {
      ...
      // ISSUE: variable of a boxed type
      __Boxed<int> y = (ValueType) worldPosition.Y;
      sewersMap.Name = string.Format(format, (object) x, (object) y);
      return sewersMap;
    }
    ...
    private Map GenerateDistrictSubwayMap(District district)
    {
      ...
      // ISSUE: variable of a boxed type
      __Boxed<int> y = (ValueType) worldPosition.Y;
      subwayMap.Name = string.Format(format, (object) x, (object) y);
      return subwayMap;
    }
    ...
    private void GeneratePlayerOnMap(Map map, BaseTownGenerator townGen)
    {
      ...
      else
      {
        ...
        actor.FoodPoints -= this.m_Rules.Roll(0, max1);
        int max2 = (int) (0.25 * (double) actor.SleepPoints);
        actor.SleepPoints -= this.m_Rules.Roll(0, max2);
      }
    ...
    private void BeforePlayerEnterDistrict(District district)
    {
      ...
      if (RogueGame.s_Options.IsSimON)
      {
        ...
        while (entryMap.LocalTime.TurnCounter <= this.m_Session.WorldTime.TurnCounter)
        {
          ...
          if ((entryMap.LocalTime.TurnCounter == this.m_Session.WorldTime.TurnCounter || entryMap.LocalTime.TurnCounter == turnCounter ? 1 : (totalMilliseconds2 >= num1 + 1000.0 ? 1 : 0)) != 0)
          {
    ...
    private bool SimulateNearbyDistricts(District d)
    {
      ...
      for (int index1 = x1; index1 <= x2; ++index1)
      {
        ...
        {
          int num1 = index1;
          Point worldPosition = d.WorldPosition;
          int x3 = worldPosition.X;
          if (num1 == x3)
          {
            int num2 = index2;
            worldPosition = d.WorldPosition;
            int y3 = worldPosition.Y;
            if (num2 == y3)
              continue;
          }
    ...
    private void CheckSpecialPlayerEventsAfterAction(Actor player)
    {
      ...
      if (!this.m_Session.Scoring.HasCompletedAchievement(Achievement.IDs.CHAR_FOUND_UNDERGROUND_FACILITY) && player.Location.Map == this.m_Session.UniqueMaps.CHARUndergroundFacility.TheMap)
      {
        lock (this.m_Session)
        {
          ...
          Point? firstInMap1 = surfaceMap.FindFirstInMap((Predicate<Point>) (pt =>
          {
          ...
          if (!firstInMap1.HasValue)
            throw new InvalidOperationException("could not find exit to CUF in surface map");
          surfaceMap.GetExitAt(firstInMap1.Value).IsAnAIExit = true;
          Point? firstInMap2 = this.m_Session.UniqueMaps.CHARUndergroundFacility.TheMap.FindFirstInMap((Predicate<Point>) (pt =>
          {
          ...
          if (!firstInMap2.HasValue)
            throw new InvalidOperationException("could not find exit to surface in CUF map");
          this.m_Session.UniqueMaps.CHARUndergroundFacility.TheMap.GetExitAt(firstInMap2.Value).IsAnAIExit = true;
        }
      }
      Location location;
      if (player != this.m_Session.UniqueActors.TheSewersThing.TheActor && !this.m_Session.PlayerKnows_TheSewersThingLocation)
      {
        Map map1 = player.Location.Map;
        location = this.m_Session.UniqueActors.TheSewersThing.TheActor.Location;
        Map map2 = location.Map;
        if (map1 == map2 && !this.m_Session.UniqueActors.TheSewersThing.TheActor.IsDead && this.IsVisibleToPlayer(this.m_Session.UniqueActors.TheSewersThing.TheActor))
        {
          lock (this.m_Session)
          {
      ...
      location = player.Location;
      if (location.Map == this.m_Session.UniqueMaps.PoliceStation_JailsLevel.TheMap && !this.m_Session.UniqueActors.PoliceStationPrisonner.TheActor.IsDead)
      {
        ...
        switch (this.m_Session.ScriptStage_PoliceStationPrisonner)
        {
          case ScriptStage.STAGE_0:
            ...
            location = player.Location;
            Point position1 = location.Position;
            Predicate<Point> predicateFn = (Predicate<Point>) (pt => map.GetMapObjectAt(pt) is PowerGenerator);
            if (map1.HasAnyAdjacentInMap(position1, predicateFn) && !theActor.IsSleeping)
            {
              lock (this.m_Session)
              {
                ...
                this.ShowSpecialDialogue(theActor, text);
          ...
          case ScriptStage.STAGE_1:
            Map map2 = map;
            location = theActor.Location;
            Point position2 = location.Position;
            string partOfName = "jail";
            if (!map2.HasZonePartiallyNamedAt(position2, partOfName))
            {
              Rules rules = this.m_Rules;
              location = player.Location;
              Point position3 = location.Position;
              ...
              if (rules.IsAdjacent(position3, position4) && !theActor.IsSleeping)
              {
                lock (this.m_Session)
                {
                  ...
                  Actor actor = this.Zombify((Actor) null, theActor, false);
                  actor.Model = this.m_GameActors.ZombiePrince;
                  actor.ActionPoints = 0;
                  this.m_Session.Scoring.AddEvent(this.m_Session.WorldTime.TurnCounter, string.Format("{0} turned into a {1}!", (object) theActor.Name, (object) actor.Model.Name));
                  this.m_MusicManager.Play(GameMusics.FIGHT);
      ...
      if (this.m_Session.UniqueItems.TheSubwayWorkerBadge.TheItem.IsEquipped)
      {
        location = player.Location;
        Map map1 = location.Map;
        location = player.Location;
        Map subwayMap = location.Map.District.SubwayMap;
        if (map1 == subwayMap && player.Inventory.Contains(this.m_Session.UniqueItems.TheSubwayWorkerBadge.TheItem))
        {
          location = player.Location;
          Map map = location.Map;
          Map map2 = map;
          ...
          if (map2.HasAnyAdjacentInMap(position, predicateFn))
          {
      ...
      Scoring scoring1 = this.m_Session.Scoring;
      location = player.Location;
      Map map3 = location.Map;
      if (!scoring1.HasVisited(map3))
      {
        Scoring scoring2 = this.m_Session.Scoring;
        int turnCounter1 = this.m_Session.WorldTime.TurnCounter;
        location = player.Location;
        Map map1 = location.Map;
        scoring2.AddVisit(turnCounter1, map1);
        Scoring scoring3 = this.m_Session.Scoring;
        int turnCounter2 = this.m_Session.WorldTime.TurnCounter;
        string format = "Visited {0}.";
        location = player.Location;
        string name = location.Map.Name;
        string text = string.Format(format, (object) name);
        scoring3.AddEvent(turnCounter2, text);
      }
      foreach (Point position in this.m_PlayerFOV)
      {
        location = player.Location;
    ...
    {
      if (a == null || a.IsDead || a.IsPlayer)
        return false;
      Location location = a.Location;
      if (location.Map.District != this.m_Session.CurrentMap.District)
        return false;
      location = a.Location;
      if (location.Map == this.m_Session.UniqueMaps.CHARUndergroundFacility.TheMap || a == this.m_Session.UniqueActors.PoliceStationPrisonner.TheActor)
        return false;
      location = a.Location;
      Map map = location.Map;
      location = a.Location;
      Map sewersMap = location.Map.District.SewersMap;
      if (map == sewersMap)
        return false;
      if (asLiving)
    ...
    private ActorAction GenerateInsaneAction(Actor actor)
    {
      switch (this.m_Rules.Roll(0, 5))
      {
        ...
        case 2:
          ...
          Map map = location.Map;
          location = actor.Location;
          Point position = location.Position + direction;
    ...
    private void DoHospitalPowerOff()
    {
      ...
      foreach (MapObject mapObject in theMap.MapObjects)
      {
        if (mapObject.ImageID == "MapObjects\\gate_open")
        {
          ...
          mapObject.ImageID = "MapObjects\\gate_closed";
          Map map = theMap;
          Location location = mapObject.Location;
          Point position = location.Position;
          Actor actorAt = map.GetActorAt(position);
          if (actorAt != null)
          {
    ...
    private bool AreLinkedByPhone(Actor speaker, Actor target)
    {
      if (speaker.Leader != target && target.Leader != speaker)
        return false;
      ItemTracker equippedItem1 = speaker.GetEquippedItem(DollPart.LEFT_HAND) as ItemTracker;
      if (equippedItem1 == null || !equippedItem1.CanTrackFollowersOrLeader)
        return false;
      ItemTracker equippedItem2 = target.GetEquippedItem(DollPart.LEFT_HAND) as ItemTracker;
      return equippedItem2 != null && equippedItem2.CanTrackFollowersOrLeader;
    }
    ...
    private class OverlayImage : RogueGame.Overlay
    {
      ...
      public override void Draw(IRogueUI ui)
      {
        ...
        rogueUi.UI_DrawImage(imageId, x, y);
      }
    }
    ...
    private class OverlayTransparentImage : RogueGame.Overlay
    {
      ...
      public override void Draw(IRogueUI ui)
      {
        ...
        screenPosition = this.ScreenPosition;
        int y = screenPosition.Y;
        rogueUi.UI_DrawTransparentImage((float) alpha, imageId, x, y);
      }
    }
    ...
    private class OverlayText : RogueGame.Overlay
    {
      ...
      public override void Draw(IRogueUI ui)
      {
        ...
        {
          IRogueUI rogueUi = ui;
          Color color = this.ShadowColor.Value;
          string text = this.Text;
          screenPosition = this.ScreenPosition;
          int gx = screenPosition.X + 1;
          screenPosition = this.ScreenPosition;
          int gy = screenPosition.Y + 1;
          Color? shadowColor = new Color?();
          rogueUi.UI_DrawString(color, text, gx, gy, shadowColor);
        }
        IRogueUI rogueUi1 = ui;
        ...
        screenPosition = this.ScreenPosition;
        int y = screenPosition.Y;
        Color? shadowColor1 = new Color?();
        rogueUi1.UI_DrawString(color1, text1, x, y, shadowColor1);
      }
    }
    ...
    private class OverlayLine : RogueGame.Overlay
    {
      ...
      public override void Draw(IRogueUI ui)
      {
        ...
        Point point = this.ScreenFrom;
        int x1 = point.X;
        point = this.ScreenFrom;
        int y1 = point.Y;
        point = this.ScreenTo;
        int x2 = point.X;
        point = this.ScreenTo;
        int y2 = point.Y;
        rogueUi.UI_DrawLine(color, x1, y1, x2, y2);
      }
    }
    ...
    private class OverlayPopup : RogueGame.Overlay
    {
      ...
      public override void Draw(IRogueUI ui)
      {
        ...
        Color boxBorderColor = this.BoxBorderColor;
        Color boxFillColor = this.BoxFillColor;
        Point screenPosition = this.ScreenPosition;
        int x = screenPosition.X;
        screenPosition = this.ScreenPosition;
        int y = screenPosition.Y;
        rogueUi.UI_DrawPopup(lines, textColor, boxBorderColor, boxFillColor, x, y);
      }
    }
