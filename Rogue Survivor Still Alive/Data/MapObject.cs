  ...
  internal class MapObject
  {
    ...
    public MapObject(string aName, string hiddenImageID, MapObject.Break breakable, MapObject.Fire burnable, int hitPoints)
    {
      ...
      if (hiddenImageID == null)
        throw new ArgumentNullException(nameof (hiddenImageID));
      this.m_Name = aName;
    ...
    private enum Flags
    {
      ...
      IS_WALKABLE = 8,
      IS_CONTAINER = 16, // 0x00000010
      IS_COUCH = 32, // 0x00000020
      GIVES_WOOD = 64, // 0x00000040
      IS_MOVABLE = 128, // 0x00000080
      BREAKS_WHEN_FIRED_THROUGH = 256, // 0x00000100
      STANDON_FOV_BONUS = 512, // 0x00000200
    }
  }
}
