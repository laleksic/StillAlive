    ...
    public void SetMinimapColor(int x, int y, Color color)
    {
      ...
      for (int index1 = 0; index1 < 2; ++index1)
      {
        for (int index2 = 0; index2 < 2; ++index2)
        {
          ...
          byte[] minimapBytes1 = this.m_MinimapBytes;
          int index3 = num3;
          int num4 = index3 + 1;
          int b = (int) color.B;
          minimapBytes1[index3] = (byte) b;
          byte[] minimapBytes2 = this.m_MinimapBytes;
          int index4 = num4;
          int num5 = index4 + 1;
          int g = (int) color.G;
          minimapBytes2[index4] = (byte) g;
          byte[] minimapBytes3 = this.m_MinimapBytes;
          int index5 = num5;
          int num6 = index5 + 1;
          int r = (int) color.R;
          minimapBytes3[index5] = (byte) r;
          byte[] minimapBytes4 = this.m_MinimapBytes;
          int index6 = num6;
          int num7 = index6 + 1;
          int maxValue = (int) byte.MaxValue;
          minimapBytes4[index6] = (byte) maxValue;
        }
      }
    }
    ...
    private class GfxTransparentImage : GDIPlusGameCanvas.IGfx
    {
      ...
      public GfxTransparentImage(float alpha, Image img, int x, int y)
      {
        ...
        float[][] newColorMatrix = new float[5][]
        {
          ...
          new float[5]{ 0.0f, 0.0f, 0.0f, alpha, 0.0f },
